...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "source",
        defaultImpl = CreateDistributedDatabaseShardDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    ...
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreateDistributedDatabaseShardWithExadbXsDetails.class,
            name = "EXADB_XS")
})
...
public class CreateDistributedDatabaseShardDetails
    ...
    protected CreateDistributedDatabaseShardDetails() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDistributedDatabaseShardDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDistributedDatabaseShardDetails)) {
            return false;
        }

        CreateDistributedDatabaseShardDetails other = (CreateDistributedDatabaseShardDetails) o;
