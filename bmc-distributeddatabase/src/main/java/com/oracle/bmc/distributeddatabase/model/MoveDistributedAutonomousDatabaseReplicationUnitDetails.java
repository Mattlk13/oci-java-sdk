...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MoveDistributedAutonomousDatabaseReplicationUnitDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MoveDistributedAutonomousDatabaseReplicationUnitDetails
    ...
    public MoveDistributedAutonomousDatabaseReplicationUnitDetails(
    ...
    public static class Builder {
        ...
        public MoveDistributedAutonomousDatabaseReplicationUnitDetails build() {
            MoveDistributedAutonomousDatabaseReplicationUnitDetails model =
                    new MoveDistributedAutonomousDatabaseReplicationUnitDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MoveDistributedAutonomousDatabaseReplicationUnitDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MoveDistributedAutonomousDatabaseReplicationUnitDetails)) {
            return false;
        }

        MoveDistributedAutonomousDatabaseReplicationUnitDetails other =
                (MoveDistributedAutonomousDatabaseReplicationUnitDetails) o;
