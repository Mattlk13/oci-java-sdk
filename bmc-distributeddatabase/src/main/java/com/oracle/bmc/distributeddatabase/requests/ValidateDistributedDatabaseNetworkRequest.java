...
public class ValidateDistributedDatabaseNetworkRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ValidateDistributedDatabaseNetworkRequest, java.lang.Void> {
        ...
        /**
         * Build the instance of ValidateDistributedDatabaseNetworkRequest as configured by this
         * builder
         *
         ...
         *
         * @return instance of ValidateDistributedDatabaseNetworkRequest
         */
        public ValidateDistributedDatabaseNetworkRequest build() {
            ValidateDistributedDatabaseNetworkRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ValidateDistributedDatabaseNetworkRequest
         */
        public ValidateDistributedDatabaseNetworkRequest buildWithoutInvocationCallback() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ValidateDistributedDatabaseNetworkRequest)) {
            return false;
        }

        ValidateDistributedDatabaseNetworkRequest other =
                (ValidateDistributedDatabaseNetworkRequest) o;
