...
/**
 * Details of the catalog peer with dedicated infrastructure. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CatalogPeerWithDedicatedInfra.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CatalogPeerWithDedicatedInfra
    ...
    public CatalogPeerWithDedicatedInfra(
    ...
    public static class Builder {
        ...
        public CatalogPeerWithDedicatedInfra build() {
            CatalogPeerWithDedicatedInfra model =
                    new CatalogPeerWithDedicatedInfra(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CatalogPeerWithDedicatedInfra model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CatalogPeerWithDedicatedInfra(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CatalogPeerWithDedicatedInfra)) {
            return false;
        }

        CatalogPeerWithDedicatedInfra other = (CatalogPeerWithDedicatedInfra) o;
