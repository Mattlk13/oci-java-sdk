...
public class MoveDistributedAutonomousDatabaseReplicationUnitRequest
    ...
    public static class Builder
        ...
        /**
         * Details required to move the replication units from the source shard to destination
         * shard.
         */
        private com.oracle.bmc.distributeddatabase.model
                        .MoveDistributedAutonomousDatabaseReplicationUnitDetails
                moveDistributedAutonomousDatabaseReplicationUnitDetails = null;

        /**
         * Details required to move the replication units from the source shard to destination
         * shard.
         *
         * @param moveDistributedAutonomousDatabaseReplicationUnitDetails the value to set
         * @return this builder instance
         */
        public Builder moveDistributedAutonomousDatabaseReplicationUnitDetails(
                com.oracle.bmc.distributeddatabase.model
                                .MoveDistributedAutonomousDatabaseReplicationUnitDetails
                        moveDistributedAutonomousDatabaseReplicationUnitDetails) {
            this.moveDistributedAutonomousDatabaseReplicationUnitDetails =
                    moveDistributedAutonomousDatabaseReplicationUnitDetails;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(MoveDistributedAutonomousDatabaseReplicationUnitRequest o) {
        ...
        /**
         * Build the instance of MoveDistributedAutonomousDatabaseReplicationUnitRequest as
         ...
         *
         * @return instance of MoveDistributedAutonomousDatabaseReplicationUnitRequest
         */
        public MoveDistributedAutonomousDatabaseReplicationUnitRequest build() {
        ...
        public Builder body$(
                com.oracle.bmc.distributeddatabase.model
                                .MoveDistributedAutonomousDatabaseReplicationUnitDetails
                        body) {
            moveDistributedAutonomousDatabaseReplicationUnitDetails(body);
            return this;
        }
         ...
         * @return instance of MoveDistributedAutonomousDatabaseReplicationUnitRequest
         */
        public MoveDistributedAutonomousDatabaseReplicationUnitRequest
                buildWithoutInvocationCallback() {
            MoveDistributedAutonomousDatabaseReplicationUnitRequest request =
                    new MoveDistributedAutonomousDatabaseReplicationUnitRequest();
            request.distributedAutonomousDatabaseId = distributedAutonomousDatabaseId;
            request.moveDistributedAutonomousDatabaseReplicationUnitDetails =
                    moveDistributedAutonomousDatabaseReplicationUnitDetails;
            ...
            return request;
            // new
            // MoveDistributedAutonomousDatabaseReplicationUnitRequest(distributedAutonomousDatabaseId, moveDistributedAutonomousDatabaseReplicationUnitDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",moveDistributedAutonomousDatabaseReplicationUnitDetails=")
                .append(
                        String.valueOf(
                                this.moveDistributedAutonomousDatabaseReplicationUnitDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MoveDistributedAutonomousDatabaseReplicationUnitRequest)) {
            return false;
        }

        MoveDistributedAutonomousDatabaseReplicationUnitRequest other =
                (MoveDistributedAutonomousDatabaseReplicationUnitRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.distributedAutonomousDatabaseId, other.distributedAutonomousDatabaseId)
                && java.util.Objects.equals(
                        this.moveDistributedAutonomousDatabaseReplicationUnitDetails,
                        other.moveDistributedAutonomousDatabaseReplicationUnitDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.moveDistributedAutonomousDatabaseReplicationUnitDetails == null
                                ? 43
                                : this.moveDistributedAutonomousDatabaseReplicationUnitDetails
                                        .hashCode());
