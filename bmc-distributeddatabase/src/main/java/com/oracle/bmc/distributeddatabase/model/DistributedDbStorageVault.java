...
/**
 * The Storage Vault for Distributed Database Resource <br>
...
public final class DistributedDbStorageVault
    ...
    public static class Builder {
        ...
        public Builder dbStorageVaultId(String dbStorageVaultId) {
            this.dbStorageVaultId = dbStorageVaultId;
            this.__explicitlySet__.add("dbStorageVaultId");
            return this;
        }
        ...
        public Builder copy(DistributedDbStorageVault model) {
            ...
            if (model.wasPropertyExplicitlySet("dbStorageVaultId")) {
                this.dbStorageVaultId(model.getDbStorageVaultId());
            }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedDbStorageVault)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.dbStorageVaultId == null ? 43 : this.dbStorageVaultId.hashCode());
        result =
                (result * PRIME)
