...
public class RecreateFailedDistributedAutonomousDatabaseResourceRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    RecreateFailedDistributedAutonomousDatabaseResourceRequest, java.lang.Void> {
        ...
        /**
         * Build the instance of RecreateFailedDistributedAutonomousDatabaseResourceRequest as
         ...
         *
         * @return instance of RecreateFailedDistributedAutonomousDatabaseResourceRequest
         */
        public RecreateFailedDistributedAutonomousDatabaseResourceRequest build() {
         ...
         * @return instance of RecreateFailedDistributedAutonomousDatabaseResourceRequest
         */
        public RecreateFailedDistributedAutonomousDatabaseResourceRequest
                buildWithoutInvocationCallback() {
            RecreateFailedDistributedAutonomousDatabaseResourceRequest request =
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RecreateFailedDistributedAutonomousDatabaseResourceRequest)) {
            return false;
        }

        RecreateFailedDistributedAutonomousDatabaseResourceRequest other =
                (RecreateFailedDistributedAutonomousDatabaseResourceRequest) o;
