...
/**
 * Globally distributed database shard. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "source",
        defaultImpl = DistributedDatabaseShard.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DistributedDatabaseShardWithExadbXsNewVaultAndCluster.class,
            name = "NEW_VAULT_AND_CLUSTER"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DistributedDatabaseShardWithExadbXs.class,
            name = "EXADB_XS")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class DistributedDatabaseShard
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "timeCreated", "timeUpdated"})
    protected DistributedDatabaseShard(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedDatabaseShard(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedDatabaseShard)) {
            return false;
        }

        DistributedDatabaseShard other = (DistributedDatabaseShard) o;
