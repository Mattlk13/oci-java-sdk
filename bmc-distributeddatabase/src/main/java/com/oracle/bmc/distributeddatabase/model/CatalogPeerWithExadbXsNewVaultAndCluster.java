...
/**
 * Details of the catalog peer <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CatalogPeerWithExadbXsNewVaultAndCluster.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CatalogPeerWithExadbXsNewVaultAndCluster
    ...
    public CatalogPeerWithExadbXsNewVaultAndCluster(
            String shardGroup,
            Status status,
    ...
    public static class Builder {
        ...
        public CatalogPeerWithExadbXsNewVaultAndCluster build() {
            CatalogPeerWithExadbXsNewVaultAndCluster model =
                    new CatalogPeerWithExadbXsNewVaultAndCluster(
                            this.shardGroup,
                            this.status,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CatalogPeerWithExadbXsNewVaultAndCluster model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CatalogPeerWithExadbXsNewVaultAndCluster(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CatalogPeerWithExadbXsNewVaultAndCluster)) {
            return false;
        }

        CatalogPeerWithExadbXsNewVaultAndCluster other =
                (CatalogPeerWithExadbXsNewVaultAndCluster) o;
        return java.util.Objects.equals(this.shardGroup, other.shardGroup)
