...
public final class DistributedAutonomousDatabaseCatalogWithDedicatedInfra
    ...
    public static class Builder {
        ...
        public DistributedAutonomousDatabaseCatalogWithDedicatedInfra build() {
            DistributedAutonomousDatabaseCatalogWithDedicatedInfra model =
                    new DistributedAutonomousDatabaseCatalogWithDedicatedInfra(
                            this.name,
                            this.timeCreated,
                            this.timeUpdated,
                            this.computeCount,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedAutonomousDatabaseCatalogWithDedicatedInfra model) {
    ...
    @Deprecated
    public DistributedAutonomousDatabaseCatalogWithDedicatedInfra(
            String name,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedAutonomousDatabaseCatalogWithDedicatedInfra(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedAutonomousDatabaseCatalogWithDedicatedInfra)) {
            return false;
        }

        DistributedAutonomousDatabaseCatalogWithDedicatedInfra other =
                (DistributedAutonomousDatabaseCatalogWithDedicatedInfra) o;
