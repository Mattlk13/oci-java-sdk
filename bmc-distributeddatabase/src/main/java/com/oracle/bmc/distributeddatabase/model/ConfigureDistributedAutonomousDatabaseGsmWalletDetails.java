...
/**
 * Details of the request to configure wallet on global service manager(GSM) instances for a
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConfigureDistributedAutonomousDatabaseGsmWalletDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ConfigureDistributedAutonomousDatabaseGsmWalletDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"certificateId", "caBundleId"})
    public ConfigureDistributedAutonomousDatabaseGsmWalletDetails(
            String certificateId, String caBundleId) {
        super();
    ...
    public static class Builder {
        ...
        public ConfigureDistributedAutonomousDatabaseGsmWalletDetails build() {
            ConfigureDistributedAutonomousDatabaseGsmWalletDetails model =
                    new ConfigureDistributedAutonomousDatabaseGsmWalletDetails(
                            this.certificateId, this.caBundleId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConfigureDistributedAutonomousDatabaseGsmWalletDetails model) {
    ...
    /**
     * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ca
     * bundle id.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("caBundleId")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigureDistributedAutonomousDatabaseGsmWalletDetails)) {
            return false;
        }

        ConfigureDistributedAutonomousDatabaseGsmWalletDetails other =
                (ConfigureDistributedAutonomousDatabaseGsmWalletDetails) o;
