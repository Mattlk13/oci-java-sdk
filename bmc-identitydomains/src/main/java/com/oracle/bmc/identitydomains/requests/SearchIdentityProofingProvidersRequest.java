...
public class SearchIdentityProofingProvidersRequest
        extends com.oracle.bmc.requests.BmcRequest<
                com.oracle.bmc.identitydomains.model.IdentityProofingProviderSearchRequest> {
    ...
    private com.oracle.bmc.identitydomains.model.IdentityProofingProviderSearchRequest
            identityProofingProviderSearchRequest;

    /** Parameters for searching IdentityProofingProviders. */
    public com.oracle.bmc.identitydomains.model.IdentityProofingProviderSearchRequest
            getIdentityProofingProviderSearchRequest() {
        return identityProofingProviderSearchRequest;
    }
    /**
    ...
    public com.oracle.bmc.identitydomains.model.IdentityProofingProviderSearchRequest getBody$() {
        return identityProofingProviderSearchRequest;
    }
    ...
    public static class Builder
        ...
        /** Parameters for searching IdentityProofingProviders. */
        private com.oracle.bmc.identitydomains.model.IdentityProofingProviderSearchRequest
                identityProofingProviderSearchRequest = null;

        /**
         * Parameters for searching IdentityProofingProviders.
         *
         * @param identityProofingProviderSearchRequest the value to set
         * @return this builder instance
         */
        public Builder identityProofingProviderSearchRequest(
                com.oracle.bmc.identitydomains.model.IdentityProofingProviderSearchRequest
                        identityProofingProviderSearchRequest) {
            this.identityProofingProviderSearchRequest = identityProofingProviderSearchRequest;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(SearchIdentityProofingProvidersRequest o) {
            authorization(o.getAuthorization());
            resourceTypeSchemaVersion(o.getResourceTypeSchemaVersion());
            identityProofingProviderSearchRequest(o.getIdentityProofingProviderSearchRequest());
        ...
        /**
         * Build the instance of SearchIdentityProofingProvidersRequest as configured by this
         * builder
         *
         ...
         *
         * @return instance of SearchIdentityProofingProvidersRequest
         */
        public SearchIdentityProofingProvidersRequest build() {
            SearchIdentityProofingProvidersRequest request = buildWithoutInvocationCallback();
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.identitydomains.model.IdentityProofingProviderSearchRequest body) {
            identityProofingProviderSearchRequest(body);
            return this;
        }
         ...
         * @return instance of SearchIdentityProofingProvidersRequest
         */
        public SearchIdentityProofingProvidersRequest buildWithoutInvocationCallback() {
            SearchIdentityProofingProvidersRequest request =
                    new SearchIdentityProofingProvidersRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.identityProofingProviderSearchRequest = identityProofingProviderSearchRequest;
            request.opcRetryToken = opcRetryToken;
            request.page = page;
            request.limit = limit;
            return request;
            // new SearchIdentityProofingProvidersRequest(authorization, resourceTypeSchemaVersion,
            // identityProofingProviderSearchRequest, opcRetryToken, page, limit);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",identityProofingProviderSearchRequest=")
                .append(String.valueOf(this.identityProofingProviderSearchRequest));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SearchIdentityProofingProvidersRequest)) {
            return false;
        }

        SearchIdentityProofingProvidersRequest other = (SearchIdentityProofingProvidersRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.identityProofingProviderSearchRequest,
                        other.identityProofingProviderSearchRequest)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.identityProofingProviderSearchRequest == null
                                ? 43
                                : this.identityProofingProviderSearchRequest.hashCode());
        result =
                (result * PRIME)
