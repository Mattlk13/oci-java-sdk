...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = IdentityProofingProviderTemplates.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class IdentityProofingProviderTemplates
    ...
    public IdentityProofingProviderTemplates(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<IdentityProofingProviderTemplate> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<IdentityProofingProviderTemplate> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<IdentityProofingProviderTemplate> resources) {
            this.resources = resources;
        ...
        public IdentityProofingProviderTemplates build() {
            IdentityProofingProviderTemplates model =
                    new IdentityProofingProviderTemplates(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IdentityProofingProviderTemplates model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<IdentityProofingProviderTemplate> resources;
     ...
     * @return the value
     */
    public java.util.List<IdentityProofingProviderTemplate> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IdentityProofingProviderTemplates)) {
            return false;
        }

        IdentityProofingProviderTemplates other = (IdentityProofingProviderTemplates) o;
