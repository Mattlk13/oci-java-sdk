...
public class PutIdentityProofingProviderRequest
    ...
    /** ID of the resource. */
    public String getIdentityProofingProviderId() {
        return identityProofingProviderId;
    }
    /**
    ...
    public static class Builder
        ...
        /** ID of the resource. */
        private String identityProofingProviderId = null;

        /**
         * ID of the resource.
         *
         * @param identityProofingProviderId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(PutIdentityProofingProviderRequest o) {
            identityProofingProviderId(o.getIdentityProofingProviderId());
        ...
        /**
         * Build the instance of PutIdentityProofingProviderRequest as configured by this builder
         *
         ...
         *
         * @return instance of PutIdentityProofingProviderRequest
         */
        public PutIdentityProofingProviderRequest build() {
            PutIdentityProofingProviderRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PutIdentityProofingProviderRequest
         */
        public PutIdentityProofingProviderRequest buildWithoutInvocationCallback() {
            PutIdentityProofingProviderRequest request = new PutIdentityProofingProviderRequest();
            ...
            return request;
            // new PutIdentityProofingProviderRequest(identityProofingProviderId, authorization,
            // resourceTypeSchemaVersion, attributes, attributeSets, identityProofingProvider,
    ...
    public String toString() {
        ...
        sb.append(",identityProofingProviderId=")
                .append(String.valueOf(this.identityProofingProviderId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutIdentityProofingProviderRequest)) {
            return false;
        }

        PutIdentityProofingProviderRequest other = (PutIdentityProofingProviderRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.identityProofingProviderId, other.identityProofingProviderId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.identityProofingProviderId == null
                                ? 43
                                : this.identityProofingProviderId.hashCode());
        result =
                (result * PRIME)
