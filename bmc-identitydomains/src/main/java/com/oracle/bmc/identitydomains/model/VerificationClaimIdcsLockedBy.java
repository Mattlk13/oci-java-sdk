...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = VerificationClaimIdcsLockedBy.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class VerificationClaimIdcsLockedBy
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ocid", "ref", "type", "display"})
    public VerificationClaimIdcsLockedBy(
    ...
    public static class Builder {
        ...
        public VerificationClaimIdcsLockedBy build() {
            VerificationClaimIdcsLockedBy model =
                    new VerificationClaimIdcsLockedBy(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VerificationClaimIdcsLockedBy model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VerificationClaimIdcsLockedBy(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VerificationClaimIdcsLockedBy)) {
            return false;
        }

        VerificationClaimIdcsLockedBy other = (VerificationClaimIdcsLockedBy) o;
