...
public class ListIdentityProofingProviderTemplatesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListIdentityProofingProviderTemplatesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListIdentityProofingProviderTemplatesRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListIdentityProofingProviderTemplatesRequest as configured by this
         * builder
         *
         ...
         *
         * @return instance of ListIdentityProofingProviderTemplatesRequest
         */
        public ListIdentityProofingProviderTemplatesRequest build() {
            ListIdentityProofingProviderTemplatesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListIdentityProofingProviderTemplatesRequest
         */
        public ListIdentityProofingProviderTemplatesRequest buildWithoutInvocationCallback() {
            ListIdentityProofingProviderTemplatesRequest request =
                    new ListIdentityProofingProviderTemplatesRequest();
            ...
            request.limit = limit;
            return request;
            // new ListIdentityProofingProviderTemplatesRequest(filter, sortBy, sortOrder,
            // startIndex, count, attributes, attributeSets, authorization,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListIdentityProofingProviderTemplatesRequest)) {
            return false;
        }

        ListIdentityProofingProviderTemplatesRequest other =
                (ListIdentityProofingProviderTemplatesRequest) o;
