...
public class DeleteIdentityProofingProviderRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteIdentityProofingProviderRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteIdentityProofingProviderRequest o) {
        ...
        /**
         * Build the instance of DeleteIdentityProofingProviderRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteIdentityProofingProviderRequest
         */
        public DeleteIdentityProofingProviderRequest build() {
            DeleteIdentityProofingProviderRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteIdentityProofingProviderRequest
         */
        public DeleteIdentityProofingProviderRequest buildWithoutInvocationCallback() {
            DeleteIdentityProofingProviderRequest request =
                    new DeleteIdentityProofingProviderRequest();
            ...
            return request;
            // new DeleteIdentityProofingProviderRequest(identityProofingProviderId, authorization,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteIdentityProofingProviderRequest)) {
            return false;
        }

        DeleteIdentityProofingProviderRequest other = (DeleteIdentityProofingProviderRequest) o;
