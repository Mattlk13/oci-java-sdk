...
public class ListIdentityProofingProvidersRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListIdentityProofingProvidersRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListIdentityProofingProvidersRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListIdentityProofingProvidersRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListIdentityProofingProvidersRequest
         */
        public ListIdentityProofingProvidersRequest build() {
            ListIdentityProofingProvidersRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListIdentityProofingProvidersRequest
         */
        public ListIdentityProofingProvidersRequest buildWithoutInvocationCallback() {
            ListIdentityProofingProvidersRequest request =
                    new ListIdentityProofingProvidersRequest();
            ...
            request.limit = limit;
            return request;
            // new ListIdentityProofingProvidersRequest(filter, sortBy, sortOrder, startIndex,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListIdentityProofingProvidersRequest)) {
            return false;
        }

        ListIdentityProofingProvidersRequest other = (ListIdentityProofingProvidersRequest) o;
