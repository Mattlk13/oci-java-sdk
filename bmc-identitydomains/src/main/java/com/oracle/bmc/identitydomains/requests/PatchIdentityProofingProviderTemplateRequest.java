...
public class PatchIdentityProofingProviderTemplateRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(PatchIdentityProofingProviderTemplateRequest o) {
        ...
        /**
         * Build the instance of PatchIdentityProofingProviderTemplateRequest as configured by this
         * builder
         *
         ...
         *
         * @return instance of PatchIdentityProofingProviderTemplateRequest
         */
        public PatchIdentityProofingProviderTemplateRequest build() {
            PatchIdentityProofingProviderTemplateRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchIdentityProofingProviderTemplateRequest
         */
        public PatchIdentityProofingProviderTemplateRequest buildWithoutInvocationCallback() {
            PatchIdentityProofingProviderTemplateRequest request =
                    new PatchIdentityProofingProviderTemplateRequest();
            ...
            return request;
            // new PatchIdentityProofingProviderTemplateRequest(identityProofingProviderTemplateId,
            // authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchIdentityProofingProviderTemplateRequest)) {
            return false;
        }

        PatchIdentityProofingProviderTemplateRequest other =
                (PatchIdentityProofingProviderTemplateRequest) o;
