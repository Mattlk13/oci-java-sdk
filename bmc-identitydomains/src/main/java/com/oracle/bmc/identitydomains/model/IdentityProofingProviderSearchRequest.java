...
public final class IdentityProofingProviderSearchRequest
    ...
    public static class Builder {
         ...
         * "attributes" query parameter is also available, union of the two is fetched. Valid
         * values: all, always, never, request, default. Values are case-insensitive. OPTIONAL.
         */
