...
/**
 * Use this endpoint to get all the verifiable claims supported by the Identity Proofing Provider.
 * This REST API is SCIM compliant. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = VerificationClaim.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class VerificationClaim
    ...
    public VerificationClaim(
            ...
            VerificationClaimIdcsLockedBy idcsLockedBy,
            String idcsLockedOn,
            ...
            String tenancyOcid,
            String oidcProvider,
            java.util.List<String> verifiableClaims) {
        super();
        this.id = id;
        this.ocid = ocid;
        ...
        this.verifiableClaims = verifiableClaims;
    }
    ...
    public static class Builder {
        ...
        private VerificationClaimIdcsLockedBy idcsLockedBy;

        public Builder idcsLockedBy(VerificationClaimIdcsLockedBy idcsLockedBy) {
            this.idcsLockedBy = idcsLockedBy;
         ...
         *
         * <p>*SCIM++ Properties:** - multiValued: false - idcsCanonicalValueSourceFilter: provider
         * eq "$(oidcProvider)" - idcsCanonicalValueSourceResourceType:
         * IdentityProofingProviderTemplate - mutability: readWrite - required: true - returned:
         * default - uniqueness: none - type: string
         */
        @com.fasterxml.jackson.annotation.JsonProperty("oidcProvider")
         ...
         * default - uniqueness: none - type: string
         *
         * @param oidcProvider the value to set
         * @return this builder
         */
        public Builder oidcProvider(String oidcProvider) {
            this.oidcProvider = oidcProvider;
            this.__explicitlySet__.add("oidcProvider");
            return this;
        }
        /**
         * Verifiable Claims.
         ...
         */
        @com.fasterxml.jackson.annotation.JsonProperty("verifiableClaims")
        private java.util.List<String> verifiableClaims;
         ...
         * readOnly - required: false - returned: default - type: string - uniqueness: none
         *
         * @param verifiableClaims the value to set
         * @return this builder
         */
        public Builder verifiableClaims(java.util.List<String> verifiableClaims) {
            this.verifiableClaims = verifiableClaims;
            this.__explicitlySet__.add("verifiableClaims");
            return this;
        }
        ...
        public VerificationClaim build() {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VerificationClaim model) {
            ...
            if (model.wasPropertyExplicitlySet("oidcProvider")) {
                this.oidcProvider(model.getOidcProvider());
            }
            if (model.wasPropertyExplicitlySet("verifiableClaims")) {
                this.verifiableClaims(model.getVerifiableClaims());
            }
            return this;
        }
    }
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("idcsLockedBy")
    private final VerificationClaimIdcsLockedBy idcsLockedBy;

    public VerificationClaimIdcsLockedBy getIdcsLockedBy() {
        return idcsLockedBy;
    }
     ...
     * The OIDC Identity Proofing Provide.
     *
     * <p>*SCIM++ Properties:** - multiValued: false - idcsCanonicalValueSourceFilter: provider eq
     * "$(oidcProvider)" - idcsCanonicalValueSourceResourceType: IdentityProofingProviderTemplate -
     * mutability: readWrite - required: true - returned: default - uniqueness: none - type: string
     */
    @com.fasterxml.jackson.annotation.JsonProperty("oidcProvider")
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("verifiableClaims")
    private final java.util.List<String> verifiableClaims;
     ...
     * @return the value
     */
    public java.util.List<String> getVerifiableClaims() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", oidcProvider=").append(String.valueOf(this.oidcProvider));
        sb.append(", verifiableClaims=").append(String.valueOf(this.verifiableClaims));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VerificationClaim)) {
            return false;
        }

        VerificationClaim other = (VerificationClaim) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.oidcProvider, other.oidcProvider)
                && java.util.Objects.equals(this.verifiableClaims, other.verifiableClaims)
                && super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.oidcProvider == null ? 43 : this.oidcProvider.hashCode());
        result =
                (result * PRIME)
                        + (this.verifiableClaims == null ? 43 : this.verifiableClaims.hashCode());
