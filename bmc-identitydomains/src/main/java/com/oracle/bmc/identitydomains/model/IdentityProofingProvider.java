...
/**
 * Manage Identity Proofing Providers. Oracle Identity Cloud Service provides cross-domain SSO
 * capabilities via the OASIS SAML 2.0 SSO protocol and implements two modes of operation for
 * Federation SSO--as an IdP where the user is authenticated on behalf of remote Service Providers
 * (SP), and as an SP where Oracle Identity Cloud Service delegates authentication to a remote IdP.
 * As an IdP, Oracle Identity Cloud Service can integrate with multiple SPs at the same time. As an
 * SP, This REST API is SCIM compliant. <br>
...
public final class IdentityProofingProvider
    ...
    public static class Builder {
         ...
         * readWrite - idcsCanonicalValueSourceFilter: provider eq "$(provider)" -
         * idcsCanonicalValueSourceResourceType: IdentityProofingProviderTemplate - caseExact: true
        ...
        /**
         * Description field to add comments and additional information about the Identity Proofing
         * Provider.
         *
         * <p>*SCIM++ Properties:** - idcsSearchable: false - multiValued: false - mutability:
         ...
         *
         * <p>*SCIM++ Properties:** - idcsSearchable: true - multiValued: false - caseExact: true -
         * mutability: readWrite - required: false - returned: default - type: string - uniqueness:
         * none
         */
         ...
         *
         * <p>*SCIM++ Properties:** - idcsCompositeKey: [attrName] - multiValued: true - mutability:
         ...
         *
         * <p>*SCIM++ Properties:** - idcsSearchable: false - multiValued: true - mutability:
         * immutable - required: true - returned: always - idcsCompositeKey: [name] - type: complex
         * - uniqueness: server
         */
         ...
         *
         * <p>*SCIM++ Properties:** - idcsSearchable: false - multiValued: true - mutability:
         * immutable - required: true - returned: always - idcsCompositeKey: [verifiableClaim] -
         * type: complex - uniqueness: server
         */
     ...
     * Configure the verification provider.
     *
     * <p>*SCIM++ Properties:** - idcsSearchable: false - multiValued: true - mutability: immutable
     * - required: true - returned: always - idcsCompositeKey: [name] - type: complex - uniqueness:
     * server
     */
    @com.fasterxml.jackson.annotation.JsonProperty("configuration")
     ...
     *
     * <p>*SCIM++ Properties:** - idcsSearchable: false - multiValued: true - mutability: immutable
     * - required: true - returned: always - idcsCompositeKey: [verifiableClaim] - type: complex -
     * uniqueness: server
     */
    @com.fasterxml.jackson.annotation.JsonProperty("claimMapping")
