...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = IdentityProofingProviders.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class IdentityProofingProviders
    ...
    public IdentityProofingProviders(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<IdentityProofingProvider> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<IdentityProofingProvider> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<IdentityProofingProvider> resources) {
            this.resources = resources;
        ...
        public IdentityProofingProviders build() {
            IdentityProofingProviders model =
                    new IdentityProofingProviders(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IdentityProofingProviders model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<IdentityProofingProvider> resources;
     ...
     * @return the value
     */
    public java.util.List<IdentityProofingProvider> getResources() {
        return resources;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("IdentityProofingProviders(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IdentityProofingProviders)) {
            return false;
        }

        IdentityProofingProviders other = (IdentityProofingProviders) o;
