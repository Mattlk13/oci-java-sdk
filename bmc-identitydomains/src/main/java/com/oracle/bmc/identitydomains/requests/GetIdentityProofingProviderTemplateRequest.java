...
public class GetIdentityProofingProviderTemplateRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetIdentityProofingProviderTemplateRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetIdentityProofingProviderTemplateRequest o) {
        ...
        /**
         * Build the instance of GetIdentityProofingProviderTemplateRequest as configured by this
         * builder
         *
         ...
         *
         * @return instance of GetIdentityProofingProviderTemplateRequest
         */
        public GetIdentityProofingProviderTemplateRequest build() {
            GetIdentityProofingProviderTemplateRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetIdentityProofingProviderTemplateRequest
         */
        public GetIdentityProofingProviderTemplateRequest buildWithoutInvocationCallback() {
            GetIdentityProofingProviderTemplateRequest request =
                    new GetIdentityProofingProviderTemplateRequest();
            ...
            return request;
            // new GetIdentityProofingProviderTemplateRequest(identityProofingProviderTemplateId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetIdentityProofingProviderTemplateRequest)) {
            return false;
        }

        GetIdentityProofingProviderTemplateRequest other =
                (GetIdentityProofingProviderTemplateRequest) o;
