...
public class ListAvailableOverrideMaintenanceStartTimesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAvailableOverrideMaintenanceStartTimesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAvailableOverrideMaintenanceStartTimesRequest o) {
            id(o.getId());
            limit(o.getLimit());
            page(o.getPage());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListAvailableOverrideMaintenanceStartTimesRequest as configured by
         * this builder
         *
         ...
         *
         * @return instance of ListAvailableOverrideMaintenanceStartTimesRequest
         */
        public ListAvailableOverrideMaintenanceStartTimesRequest build() {
         ...
         * @return instance of ListAvailableOverrideMaintenanceStartTimesRequest
         */
        public ListAvailableOverrideMaintenanceStartTimesRequest buildWithoutInvocationCallback() {
            ListAvailableOverrideMaintenanceStartTimesRequest request =
                    new ListAvailableOverrideMaintenanceStartTimesRequest();
            request.id = id;
            request.limit = limit;
            request.page = page;
            ...
            return request;
            // new ListAvailableOverrideMaintenanceStartTimesRequest(id, limit, page, sortBy,
            // sortOrder, date, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAvailableOverrideMaintenanceStartTimesRequest)) {
            return false;
        }

        ListAvailableOverrideMaintenanceStartTimesRequest other =
                (ListAvailableOverrideMaintenanceStartTimesRequest) o;
