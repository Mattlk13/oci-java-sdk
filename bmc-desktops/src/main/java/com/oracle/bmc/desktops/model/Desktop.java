...
/**
 * Provides information about a desktop including name, state, id, configuration, owner, and time
 * created. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Desktop.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class Desktop extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("hostingOptions")
        private HostingOptions hostingOptions;

        public Builder hostingOptions(HostingOptions hostingOptions) {
            this.hostingOptions = hostingOptions;
            this.__explicitlySet__.add("hostingOptions");
            return this;
        }
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Desktop model) {
            ...
            if (model.wasPropertyExplicitlySet("hostingOptions")) {
                this.hostingOptions(model.getHostingOptions());
            }
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("hostingOptions")
    private final HostingOptions hostingOptions;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", hostingOptions=").append(String.valueOf(this.hostingOptions));
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.hostingOptions, other.hostingOptions)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.hostingOptions == null ? 43 : this.hostingOptions.hashCode());
