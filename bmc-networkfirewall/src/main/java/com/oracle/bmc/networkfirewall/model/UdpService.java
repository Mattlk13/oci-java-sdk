...
/**
 * UDP Service used on the firewall policy rules. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = UdpService.Builder.class)
...
public final class UdpService extends Service {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UdpService model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UdpService)) {
            return false;
        }

        UdpService other = (UdpService) o;
