...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "type",
        defaultImpl = UpdateAddressListDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateFqdnAddressListDetails.class,
            name = "FQDN"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateIpAddressListDetails.class,
            name = "IP")
})
...
public class UpdateAddressListDetails
    ...
    protected UpdateAddressListDetails(String description) {
        super();
