...
/**
 * Request for creating SSLForwardProxy used on the firewall policy rules. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateSslForwardProxyProfileDetails.Builder.class)
...
public final class CreateSslForwardProxyProfileDetails extends CreateDecryptionProfileDetails {
    ...
    public static class Builder {
        ...
        public CreateSslForwardProxyProfileDetails build() {
            CreateSslForwardProxyProfileDetails model =
                    new CreateSslForwardProxyProfileDetails(
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateSslForwardProxyProfileDetails model) {
    ...
    @Deprecated
    public CreateSslForwardProxyProfileDetails(
            String name,
            String description,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSslForwardProxyProfileDetails)) {
            return false;
        }

        CreateSslForwardProxyProfileDetails other = (CreateSslForwardProxyProfileDetails) o;
