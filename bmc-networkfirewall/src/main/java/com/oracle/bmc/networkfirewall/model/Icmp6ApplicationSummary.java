...
/**
 * Summary object for ICMP V6 application element in the network firewall policy. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = Icmp6ApplicationSummary.Builder.class)
...
public final class Icmp6ApplicationSummary extends ApplicationSummary {
    ...
    public static class Builder {
        ...
        public Icmp6ApplicationSummary build() {
            Icmp6ApplicationSummary model =
                    new Icmp6ApplicationSummary(
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Icmp6ApplicationSummary model) {
    ...
    @Deprecated
    public Icmp6ApplicationSummary(
            String name,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("Icmp6ApplicationSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Icmp6ApplicationSummary)) {
            return false;
        }

        Icmp6ApplicationSummary other = (Icmp6ApplicationSummary) o;
