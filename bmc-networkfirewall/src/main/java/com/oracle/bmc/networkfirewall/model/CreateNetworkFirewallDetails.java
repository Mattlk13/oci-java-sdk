...
/**
 * The information about new Network Firewall. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateNetworkFirewallDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateNetworkFirewallDetails
    ...
    public CreateNetworkFirewallDetails(
            String displayName,
    ...
    public static class Builder {
        ...
        public CreateNetworkFirewallDetails build() {
            CreateNetworkFirewallDetails model =
                    new CreateNetworkFirewallDetails(
                            this.displayName,
                            this.compartmentId,
                            this.subnetId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateNetworkFirewallDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateNetworkFirewallDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateNetworkFirewallDetails)) {
            return false;
        }

        CreateNetworkFirewallDetails other = (CreateNetworkFirewallDetails) o;
