...
/**
 * The request details to be updated in the Vault Mapped Secret for the policy. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateVaultMappedSecretDetails.Builder.class)
...
public final class UpdateVaultMappedSecretDetails extends UpdateMappedSecretDetails {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateVaultMappedSecretDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateVaultMappedSecretDetails)) {
            return false;
        }

        UpdateVaultMappedSecretDetails other = (UpdateVaultMappedSecretDetails) o;
