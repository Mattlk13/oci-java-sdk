...
public final class UpdateTcpServiceDetails extends UpdateServiceDetails {
    ...
    public static class Builder {
        ...
        public UpdateTcpServiceDetails build() {
            UpdateTcpServiceDetails model =
                    new UpdateTcpServiceDetails(this.description, this.portRanges);
    ...
    @Deprecated
    public UpdateTcpServiceDetails(String description, java.util.List<PortRange> portRanges) {
        super(description);
        this.portRanges = portRanges;
    }
