...
/**
 * Request for creating Vxlan Tunnel Inspection Rule used in the firewall policy rules. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateVxlanInspectionRuleDetails.Builder.class)
...
public final class CreateVxlanInspectionRuleDetails extends CreateTunnelInspectionRuleDetails {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateVxlanInspectionRuleDetails model) {
    ...
    @Deprecated
    public CreateVxlanInspectionRuleDetails(
            String name,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVxlanInspectionRuleDetails)) {
            return false;
        }

        CreateVxlanInspectionRuleDetails other = (CreateVxlanInspectionRuleDetails) o;
