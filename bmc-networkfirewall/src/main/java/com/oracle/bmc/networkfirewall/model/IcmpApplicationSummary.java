...
/**
 * Summary object for ICMP application element in the network firewall policy. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = IcmpApplicationSummary.Builder.class)
...
public final class IcmpApplicationSummary extends ApplicationSummary {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IcmpApplicationSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IcmpApplicationSummary)) {
            return false;
        }

        IcmpApplicationSummary other = (IcmpApplicationSummary) o;
