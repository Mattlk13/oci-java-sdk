...
/**
 * Update Request for Decryption Profile used on the firewall policy rules. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "type",
        defaultImpl = UpdateDecryptionProfileDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateSslInboundInspectionProfileDetails.class,
            name = "SSL_INBOUND_INSPECTION"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateSslForwardProxyProfileDetails.class,
...
public class UpdateDecryptionProfileDetails
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDecryptionProfileDetails)) {
            return false;
        }
