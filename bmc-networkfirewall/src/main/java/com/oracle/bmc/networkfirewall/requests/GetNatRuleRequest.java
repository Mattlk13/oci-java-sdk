 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetNatRuleRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230501")
public class GetNatRuleRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetNatRuleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetNatRuleRequest o) {
        ...
        /**
         * Build the instance of GetNatRuleRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetNatRuleRequest
         */
        public GetNatRuleRequest build() {
            GetNatRuleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetNatRuleRequest
         */
        public GetNatRuleRequest buildWithoutInvocationCallback() {
            GetNatRuleRequest request = new GetNatRuleRequest();
            request.networkFirewallPolicyId = networkFirewallPolicyId;
            request.natRuleName = natRuleName;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetNatRuleRequest(networkFirewallPolicyId, natRuleName, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetNatRuleRequest)) {
            return false;
        }

        GetNatRuleRequest other = (GetNatRuleRequest) o;
