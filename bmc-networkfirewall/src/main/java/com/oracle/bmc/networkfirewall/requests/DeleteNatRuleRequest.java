 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteNatRuleRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230501")
public class DeleteNatRuleRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteNatRuleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteNatRuleRequest o) {
        ...
        /**
         * Build the instance of DeleteNatRuleRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteNatRuleRequest
         */
        public DeleteNatRuleRequest build() {
            DeleteNatRuleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteNatRuleRequest
         */
        public DeleteNatRuleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteNatRuleRequest(networkFirewallPolicyId, natRuleName, ifMatch,
            // opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteNatRuleRequest)) {
            return false;
        }

        DeleteNatRuleRequest other = (DeleteNatRuleRequest) o;
