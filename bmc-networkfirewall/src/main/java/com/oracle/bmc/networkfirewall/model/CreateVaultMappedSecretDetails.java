...
/**
 * The request details to be created in the Vault Mapped Secret for the policy. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateVaultMappedSecretDetails.Builder.class)
...
public final class CreateVaultMappedSecretDetails extends CreateMappedSecretDetails {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateVaultMappedSecretDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateVaultMappedSecretDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVaultMappedSecretDetails)) {
            return false;
        }

        CreateVaultMappedSecretDetails other = (CreateVaultMappedSecretDetails) o;
