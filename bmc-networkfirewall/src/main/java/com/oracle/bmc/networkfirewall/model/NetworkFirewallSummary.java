...
/**
 * Summary of the Network Firewall. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = NetworkFirewallSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class NetworkFirewallSummary
    ...
    public static class Builder {
        ...
        public NetworkFirewallSummary build() {
            NetworkFirewallSummary model =
                    new NetworkFirewallSummary(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.subnetId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NetworkFirewallSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("NetworkFirewallSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkFirewallSummary)) {
            return false;
        }

        NetworkFirewallSummary other = (NetworkFirewallSummary) o;
