...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "type",
        defaultImpl = UpdateApplicationDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateIcmp6ApplicationDetails.class,
            name = "ICMP_V6"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateIcmpApplicationDetails.class,
            name = "ICMP")
})
...
public class UpdateApplicationDetails
    ...
    protected UpdateApplicationDetails(String description) {
        super();
