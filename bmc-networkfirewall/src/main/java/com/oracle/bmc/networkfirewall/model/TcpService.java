...
/**
 * TCP Service used on the firewall policy rules. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = TcpService.Builder.class)
...
public final class TcpService extends Service {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TcpService model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TcpService)) {
            return false;
        }

        TcpService other = (TcpService) o;
