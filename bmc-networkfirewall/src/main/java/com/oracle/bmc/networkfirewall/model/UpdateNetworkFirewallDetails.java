...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateNetworkFirewallDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateNetworkFirewallDetails
    ...
    public UpdateNetworkFirewallDetails(
            String displayName,
    ...
    public static class Builder {
        ...
        public UpdateNetworkFirewallDetails build() {
            UpdateNetworkFirewallDetails model =
                    new UpdateNetworkFirewallDetails(
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateNetworkFirewallDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateNetworkFirewallDetails)) {
            return false;
        }

        UpdateNetworkFirewallDetails other = (UpdateNetworkFirewallDetails) o;
