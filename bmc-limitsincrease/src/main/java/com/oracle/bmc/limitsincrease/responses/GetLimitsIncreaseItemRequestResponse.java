...
public class GetLimitsIncreaseItemRequestResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetLimitsIncreaseItemRequestResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetLimitsIncreaseItemRequestResponse o) {
         ...
         */
        @Override
        public GetLimitsIncreaseItemRequestResponse build() {
            return new GetLimitsIncreaseItemRequestResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetLimitsIncreaseItemRequestResponse)) {
            return false;
        }

        GetLimitsIncreaseItemRequestResponse other = (GetLimitsIncreaseItemRequestResponse) o;
