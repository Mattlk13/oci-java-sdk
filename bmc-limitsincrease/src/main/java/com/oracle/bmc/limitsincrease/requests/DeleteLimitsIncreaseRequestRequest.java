...
public class DeleteLimitsIncreaseRequestRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteLimitsIncreaseRequestRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteLimitsIncreaseRequestRequest o) {
        ...
        /**
         * Build the instance of DeleteLimitsIncreaseRequestRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteLimitsIncreaseRequestRequest
         */
        public DeleteLimitsIncreaseRequestRequest build() {
            DeleteLimitsIncreaseRequestRequest request = buildWithoutInvocationCallback();
        ...
        public DeleteLimitsIncreaseRequestRequest buildWithoutInvocationCallback() {
            DeleteLimitsIncreaseRequestRequest request = new DeleteLimitsIncreaseRequestRequest();
            request.limitsIncreaseRequestId = limitsIncreaseRequestId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteLimitsIncreaseRequestRequest(limitsIncreaseRequestId, opcRequestId,
            // ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteLimitsIncreaseRequestRequest)) {
            return false;
        }

        DeleteLimitsIncreaseRequestRequest other = (DeleteLimitsIncreaseRequestRequest) o;
