...
/**
 * An operation in a single patch instruction for a new comment to be added to the limit increase
 * request. The operation inserts a value into an array, shifting array items as necessary and
 * handling {@code NOT_FOUND} exceptions by creating the implied containing structure. <br>
...
public final class PatchInsertInstruction extends PatchInstruction {
    ...
    public static class Builder {
        ...
        public PatchInsertInstruction build() {
            PatchInsertInstruction model = new PatchInsertInstruction(this.selection, this.value);
