...
/**
 * Collection discovery conformed by the specified list of targets. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GiTargetListDiscovery.Builder.class)
...
public final class GiTargetListDiscovery extends GiFleetDiscoveryDetails {
    ...
    public static class Builder {
        ...
        public GiTargetListDiscovery build() {
            GiTargetListDiscovery model = new GiTargetListDiscovery(this.targets);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GiTargetListDiscovery model) {
    ...
    @Deprecated
    public GiTargetListDiscovery(java.util.List<String> targets) {
        super();
        this.targets = targets;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GiTargetListDiscovery(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GiTargetListDiscovery)) {
            return false;
        }

        GiTargetListDiscovery other = (GiTargetListDiscovery) o;
