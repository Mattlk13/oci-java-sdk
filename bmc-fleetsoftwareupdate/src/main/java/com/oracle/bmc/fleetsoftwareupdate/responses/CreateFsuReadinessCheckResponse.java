...
public class CreateFsuReadinessCheckResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateFsuReadinessCheckResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CreateFsuReadinessCheckResponse o) {
         ...
         */
        @Override
        public CreateFsuReadinessCheckResponse build() {
            return new CreateFsuReadinessCheckResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateFsuReadinessCheckResponse)) {
            return false;
        }

        CreateFsuReadinessCheckResponse other = (CreateFsuReadinessCheckResponse) o;
