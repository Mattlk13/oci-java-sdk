...
public class UpdateFsuReadinessCheckResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /** The returned {@code FsuReadinessCheck} instance. */
    ...
    private UpdateFsuReadinessCheckResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateFsuReadinessCheckResponse o) {
         ...
         */
        @Override
        public UpdateFsuReadinessCheckResponse build() {
            return new UpdateFsuReadinessCheckResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, fsuReadinessCheck);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateFsuReadinessCheckResponse)) {
            return false;
        }

        UpdateFsuReadinessCheckResponse other = (UpdateFsuReadinessCheckResponse) o;
