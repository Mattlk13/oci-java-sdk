...
/**
 * The summary of an OS patch action history on a DB system. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DbSystemOsPatchHistoryEntrySummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DbSystemOsPatchHistoryEntrySummary
    ...
    public DbSystemOsPatchHistoryEntrySummary(
            Action action,
            String dbSystemId,
            String id,
    ...
    public static class Builder {
        ...
        public DbSystemOsPatchHistoryEntrySummary build() {
            DbSystemOsPatchHistoryEntrySummary model =
                    new DbSystemOsPatchHistoryEntrySummary(
                            this.action,
                            this.dbSystemId,
                            this.id,
                            this.lifecycleState,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DbSystemOsPatchHistoryEntrySummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DbSystemOsPatchHistoryEntrySummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DbSystemOsPatchHistoryEntrySummary)) {
            return false;
        }

        DbSystemOsPatchHistoryEntrySummary other = (DbSystemOsPatchHistoryEntrySummary) o;
