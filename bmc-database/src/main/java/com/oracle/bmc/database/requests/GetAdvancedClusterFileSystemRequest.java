...
public class GetAdvancedClusterFileSystemRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetAdvancedClusterFileSystemRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetAdvancedClusterFileSystemRequest o) {
        ...
        /**
         * Build the instance of GetAdvancedClusterFileSystemRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAdvancedClusterFileSystemRequest
         */
        public GetAdvancedClusterFileSystemRequest build() {
            GetAdvancedClusterFileSystemRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAdvancedClusterFileSystemRequest
         */
        public GetAdvancedClusterFileSystemRequest buildWithoutInvocationCallback() {
            GetAdvancedClusterFileSystemRequest request = new GetAdvancedClusterFileSystemRequest();
            request.advancedClusterFileSystemId = advancedClusterFileSystemId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetAdvancedClusterFileSystemRequest(advancedClusterFileSystemId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAdvancedClusterFileSystemRequest)) {
            return false;
        }

        GetAdvancedClusterFileSystemRequest other = (GetAdvancedClusterFileSystemRequest) o;
