...
/**
 * Details of an advanced cluster file system. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AdvancedClusterFileSystemSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AdvancedClusterFileSystemSummary
    ...
    public AdvancedClusterFileSystemSummary(
            String id,
            String name,
            ...
            String vaultId,
            String description,
            AdvancedClusterFileSystem.LifecycleState lifecycleState,
    ...
    public static class Builder {
        ...
        /**
         * The user-friendly name for the Advanced cluster file system. The file system name is
         * unique for a cluster.
         */
        ...
        private AdvancedClusterFileSystem.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(AdvancedClusterFileSystem.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public AdvancedClusterFileSystemSummary build() {
            AdvancedClusterFileSystemSummary model =
                    new AdvancedClusterFileSystemSummary(
                            this.id,
                            this.name,
                            this.compartmentId,
                            this.vmClusterId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdvancedClusterFileSystemSummary model) {
    ...
    /**
     * The user-friendly name for the Advanced cluster file system. The file system name is unique
     * for a cluster.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("name")
    ...
    /** The current state of the advanced cluster file system. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final AdvancedClusterFileSystem.LifecycleState lifecycleState;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdvancedClusterFileSystemSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdvancedClusterFileSystemSummary)) {
            return false;
        }

        AdvancedClusterFileSystemSummary other = (AdvancedClusterFileSystemSummary) o;
