...
public final class AutonomousDatabaseSummary
    ...
    public static class Builder {
        ...
        public AutonomousDatabaseSummary build() {
            AutonomousDatabaseSummary model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutonomousDatabaseSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AutonomousDatabaseSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutonomousDatabaseSummary)) {
            return false;
        }
