...
public class CreateAutonomousDatabaseBase
    ...
    /**
     * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
     * compartment of the Autonomous AI Database.
     */
    ...
    /**
     * The character set for the Autonomous AI Database. The default is AL32UTF8. Allowed values for
     * an Autonomous AI Database Serverless instance as as returned by [List Autonomous AI Database
     * Character
     * Sets](https://docs.oracle.com/iaas/autonomous-database-serverless/doc/autonomous-character-set-selection.html)
     *
     * <p>For an Autonomous AI Database on dedicated infrastructure, the allowed values are:
     *
    ...
    /**
     * The character set for the Autonomous AI Database. The default is AL32UTF8. Use [List
     * Autonomous AI Database Character
     * Sets](https://docs.oracle.com/iaas/autonomous-database-serverless/doc/autonomous-character-set-selection.html)
     * to list the allowed values for an Autonomous AI Database Serverless instance. For an
     * Autonomous AI Database on dedicated Exadata infrastructure, the allowed values are: AL16UTF16
     * or UTF8.
     */
     ...
     * of 30 alphanumeric characters. Special characters are not permitted. The database name must
     * be unique in the tenancy. It is required in all cases except when creating a cross-region
     * Autonomous Data Guard standby instance or a cross-region disaster recovery standby instance.
     */
    ...
    /**
     * The number of CPU cores to be made available to the database. For Autonomous AI Databases on
     ...
     * To provision 1 or more cores, you must enter an integer between 1 and the maximum number of
     * cores available for the infrastructure shape. For example, you can provision 2 cores or 3
     * cores, but not 2.5 cores. This applies to an Autonomous AI Database Serverless instance or an
     * Autonomous AI Database on Dedicated Exadata Infrastructure. - For Autonomous AI Database
     * Serverless instances, this parameter is not used.
     *
     ...
     * This storage can later be scaled up if needed. For Autonomous AI Databases on dedicated
     * Exadata infrastructure, the maximum storage value is determined by the infrastructure shape.
     ...
     * This storage can later be scaled up if needed. The maximum storage value is determined by the
     * infrastructure shape. See [Characteristics of Infrastructure
     * Shapes](https://docs.oracle.com/en/cloud/paas/autonomous-database/dedicated/adbde/) for shape
     * details.
     *
     * <p>*Notes** - This parameter is only supported for dedicated Exadata infrastructure. - This
     * parameter cannot be used with the {@code dataStorageSizeInTBs} parameter.
     */
     ...
     * Autonomous AI Databases except for refreshable clones. The password must be between 12 and 30
    ...
    /**
     * If set to {@code TRUE}, indicates that an Autonomous AI Database preview version is being
     * provisioned, and that the preview version's terms of service have been accepted. Note that
     * preview version software is only available for Autonomous AI Database Serverless instances
    ...
    /**
     * The source of the database: Use {@code NONE} for creating a new Autonomous AI Database. Use
     * {@code DATABASE} for creating a new Autonomous AI Database by cloning an existing Autonomous
     * AI Database. Use {@code CROSS_REGION_DATAGUARD} to create a standby Data Guard database in
     * another region.
     *
     * <p>For [Autonomous AI Database Serverless
     * instances](https://docs.oracle.com/en/cloud/paas/autonomous-database/serverless/), the
     * following cloning options are available: Use {@code BACKUP_FROM_ID} for creating a new
     * Autonomous AI Database from a specified backup. Use {@code BACKUP_FROM_TIMESTAMP} for
     * creating a point-in-time Autonomous AI Database clone using backups. For more information,
     * see [Cloning and Moving an Autonomous AI
     * Database](https://docs.oracle.com/en/cloud/paas/autonomous-database/adbsa/clone-autonomous-database.html#GUID-D771796F-5081-4CFB-A7FF-0F893EABD7BC).
     */
