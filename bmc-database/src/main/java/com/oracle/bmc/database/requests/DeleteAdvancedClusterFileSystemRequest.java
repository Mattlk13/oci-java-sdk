...
public class DeleteAdvancedClusterFileSystemRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteAdvancedClusterFileSystemRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAdvancedClusterFileSystemRequest o) {
        ...
        /**
         * Build the instance of DeleteAdvancedClusterFileSystemRequest as configured by this
         * builder
         *
         ...
         *
         * @return instance of DeleteAdvancedClusterFileSystemRequest
         */
        public DeleteAdvancedClusterFileSystemRequest build() {
            DeleteAdvancedClusterFileSystemRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAdvancedClusterFileSystemRequest
         */
        public DeleteAdvancedClusterFileSystemRequest buildWithoutInvocationCallback() {
            DeleteAdvancedClusterFileSystemRequest request =
                    new DeleteAdvancedClusterFileSystemRequest();
            request.advancedClusterFileSystemId = advancedClusterFileSystemId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteAdvancedClusterFileSystemRequest(advancedClusterFileSystemId, ifMatch,
            // opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAdvancedClusterFileSystemRequest)) {
            return false;
        }

        DeleteAdvancedClusterFileSystemRequest other = (DeleteAdvancedClusterFileSystemRequest) o;
