...
/**
 * Describes the modification parameters for the advanced cluster file system. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateAdvancedClusterFileSystemDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateAdvancedClusterFileSystemDetails
    ...
    public UpdateAdvancedClusterFileSystemDetails(
    ...
    public static class Builder {
        ...
        public UpdateAdvancedClusterFileSystemDetails build() {
            UpdateAdvancedClusterFileSystemDetails model =
                    new UpdateAdvancedClusterFileSystemDetails(
                            this.storageInGBs,
                            this.vmClusterId,
                            this.freeformTags,
                            this.definedTags);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateAdvancedClusterFileSystemDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAdvancedClusterFileSystemDetails)) {
            return false;
        }

        UpdateAdvancedClusterFileSystemDetails other = (UpdateAdvancedClusterFileSystemDetails) o;
        return java.util.Objects.equals(this.storageInGBs, other.storageInGBs)
