...
/**
 * Used for creating a new standby database system in dataguard environment. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = LaunchStandbyDbSystemDetails.Builder.class)
...
public final class LaunchStandbyDbSystemDetails extends LaunchDbSystemBase {
    ...
    public static class Builder {
        ...
        private CreateDbHomeForStandbyDbSystem dbHome;

        public Builder dbHome(CreateDbHomeForStandbyDbSystem dbHome) {
            this.dbHome = dbHome;
        ...
        public LaunchStandbyDbSystemDetails build() {
            LaunchStandbyDbSystemDetails model =
                    new LaunchStandbyDbSystemDetails(
                            this.compartmentId,
                            this.faultDomains,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LaunchStandbyDbSystemDetails model) {
    ...
    @Deprecated
    public LaunchStandbyDbSystemDetails(
            ...
            CreateDbHomeForStandbyDbSystem dbHome,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("dbHome")
    private final CreateDbHomeForStandbyDbSystem dbHome;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("LaunchStandbyDbSystemDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LaunchStandbyDbSystemDetails)) {
            return false;
        }

        LaunchStandbyDbSystemDetails other = (LaunchStandbyDbSystemDetails) o;
