...
public final class AdvancedClusterFileSystem
    ...
    public static class Builder {
        ...
        /**
         * The current state of the advanced cluster file system. Valid states are CREATING,
         * AVAILABLE, UPDATING, FAILED, DELETED.
         */
    ...
    /**
     * The current state of the advanced cluster file system. Valid states are CREATING, AVAILABLE,
     * UPDATING, FAILED, DELETED.
     */
