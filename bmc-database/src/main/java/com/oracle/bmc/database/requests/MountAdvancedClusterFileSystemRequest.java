...
public class MountAdvancedClusterFileSystemRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    MountAdvancedClusterFileSystemRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(MountAdvancedClusterFileSystemRequest o) {
        ...
        /**
         * Build the instance of MountAdvancedClusterFileSystemRequest as configured by this builder
         *
         ...
         *
         * @return instance of MountAdvancedClusterFileSystemRequest
         */
        public MountAdvancedClusterFileSystemRequest build() {
            MountAdvancedClusterFileSystemRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of MountAdvancedClusterFileSystemRequest
         */
        public MountAdvancedClusterFileSystemRequest buildWithoutInvocationCallback() {
            MountAdvancedClusterFileSystemRequest request =
                    new MountAdvancedClusterFileSystemRequest();
            request.advancedClusterFileSystemId = advancedClusterFileSystemId;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new MountAdvancedClusterFileSystemRequest(advancedClusterFileSystemId, opcRetryToken,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MountAdvancedClusterFileSystemRequest)) {
            return false;
        }

        MountAdvancedClusterFileSystemRequest other = (MountAdvancedClusterFileSystemRequest) o;
