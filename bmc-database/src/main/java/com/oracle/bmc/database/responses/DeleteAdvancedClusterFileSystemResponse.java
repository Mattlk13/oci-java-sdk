...
public class DeleteAdvancedClusterFileSystemResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteAdvancedClusterFileSystemResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DeleteAdvancedClusterFileSystemResponse o) {
         ...
         */
        @Override
        public DeleteAdvancedClusterFileSystemResponse build() {
            return new DeleteAdvancedClusterFileSystemResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAdvancedClusterFileSystemResponse)) {
            return false;
        }

        DeleteAdvancedClusterFileSystemResponse other = (DeleteAdvancedClusterFileSystemResponse) o;
