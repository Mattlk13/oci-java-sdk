...
public class UnmountAdvancedClusterFileSystemRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    UnmountAdvancedClusterFileSystemRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(UnmountAdvancedClusterFileSystemRequest o) {
        ...
        /**
         * Build the instance of UnmountAdvancedClusterFileSystemRequest as configured by this
         * builder
         *
         ...
         *
         * @return instance of UnmountAdvancedClusterFileSystemRequest
         */
        public UnmountAdvancedClusterFileSystemRequest build() {
            UnmountAdvancedClusterFileSystemRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of UnmountAdvancedClusterFileSystemRequest
         */
        public UnmountAdvancedClusterFileSystemRequest buildWithoutInvocationCallback() {
            UnmountAdvancedClusterFileSystemRequest request =
                    new UnmountAdvancedClusterFileSystemRequest();
            request.advancedClusterFileSystemId = advancedClusterFileSystemId;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new UnmountAdvancedClusterFileSystemRequest(advancedClusterFileSystemId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnmountAdvancedClusterFileSystemRequest)) {
            return false;
        }

        UnmountAdvancedClusterFileSystemRequest other = (UnmountAdvancedClusterFileSystemRequest) o;
