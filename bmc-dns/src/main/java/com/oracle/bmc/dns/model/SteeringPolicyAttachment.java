...
/**
 * An attachment between a steering policy and a domain. An attachment constructs DNS responses
 * using its steering policy instead of the records at its defined domain. Only records of the
 * policy's covered rtype are blocked at the domain. A domain can have a maximum of one attachment
 * covering any given rtype.
 *
