...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudExadataStorageServerSummary.Builder.class)
...
public final class CloudExadataStorageServerSummary extends DbmResource {
    ...
    public static class Builder {
        ...
        public CloudExadataStorageServerSummary build() {
            CloudExadataStorageServerSummary model =
                    new CloudExadataStorageServerSummary(
                            this.id,
                            this.displayName,
                            this.version,
                            this.internalId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudExadataStorageServerSummary model) {
    ...
    @Deprecated
    public CloudExadataStorageServerSummary(
            String id,
            String displayName,
            String version,
            String internalId,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudExadataStorageServerSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudExadataStorageServerSummary)) {
            return false;
        }

        CloudExadataStorageServerSummary other = (CloudExadataStorageServerSummary) o;
