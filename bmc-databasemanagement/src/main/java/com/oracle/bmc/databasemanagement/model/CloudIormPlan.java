...
/**
 * The IORM plan from an Exadata storage server. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = CloudIormPlan.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CloudIormPlan extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"planStatus", "planObjective", "dbPlan"})
    public CloudIormPlan(
    ...
    public static class Builder {
        ...
        public CloudIormPlan build() {
            CloudIormPlan model =
                    new CloudIormPlan(this.planStatus, this.planObjective, this.dbPlan);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudIormPlan model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudIormPlan)) {
            return false;
        }

        CloudIormPlan other = (CloudIormPlan) o;
