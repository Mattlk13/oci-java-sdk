...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StorageServerDiscoverySummary.Builder.class)
...
public final class StorageServerDiscoverySummary extends EntityDiscovered {
    ...
    public static class Builder {
        ...
        public StorageServerDiscoverySummary build() {
            StorageServerDiscoverySummary model =
                    new StorageServerDiscoverySummary(
                            this.id,
                            this.agentId,
                            this.connectorId,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StorageServerDiscoverySummary model) {
    ...
    @Deprecated
    public StorageServerDiscoverySummary(
            String id,
            String agentId,
            String connectorId,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StorageServerDiscoverySummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StorageServerDiscoverySummary)) {
            return false;
        }

        StorageServerDiscoverySummary other = (StorageServerDiscoverySummary) o;
