...
public class DeleteCloudExadataStorageConnectorRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteCloudExadataStorageConnectorRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteCloudExadataStorageConnectorRequest o) {
        ...
        /**
         * Build the instance of DeleteCloudExadataStorageConnectorRequest as configured by this
         * builder
         *
         ...
         *
         * @return instance of DeleteCloudExadataStorageConnectorRequest
         */
        public DeleteCloudExadataStorageConnectorRequest build() {
            DeleteCloudExadataStorageConnectorRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteCloudExadataStorageConnectorRequest
         */
        public DeleteCloudExadataStorageConnectorRequest buildWithoutInvocationCallback() {
            DeleteCloudExadataStorageConnectorRequest request =
                    new DeleteCloudExadataStorageConnectorRequest();
            request.cloudExadataStorageConnectorId = cloudExadataStorageConnectorId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteCloudExadataStorageConnectorRequest(cloudExadataStorageConnectorId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteCloudExadataStorageConnectorRequest)) {
            return false;
        }

        DeleteCloudExadataStorageConnectorRequest other =
                (DeleteCloudExadataStorageConnectorRequest) o;
