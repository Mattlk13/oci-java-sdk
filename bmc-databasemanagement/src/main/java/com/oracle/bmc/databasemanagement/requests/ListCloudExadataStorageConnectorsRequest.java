...
public class ListCloudExadataStorageConnectorsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListCloudExadataStorageConnectorsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListCloudExadataStorageConnectorsRequest o) {
        ...
        /**
         * Build the instance of ListCloudExadataStorageConnectorsRequest as configured by this
         * builder
         *
         ...
         *
         * @return instance of ListCloudExadataStorageConnectorsRequest
         */
        public ListCloudExadataStorageConnectorsRequest build() {
            ListCloudExadataStorageConnectorsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCloudExadataStorageConnectorsRequest
         */
        public ListCloudExadataStorageConnectorsRequest buildWithoutInvocationCallback() {
            ListCloudExadataStorageConnectorsRequest request =
                    new ListCloudExadataStorageConnectorsRequest();
            ...
            return request;
            // new ListCloudExadataStorageConnectorsRequest(compartmentId,
            // cloudExadataInfrastructureId, displayName, page, limit, sortBy, sortOrder,
            // opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCloudExadataStorageConnectorsRequest)) {
            return false;
        }

        ListCloudExadataStorageConnectorsRequest other =
                (ListCloudExadataStorageConnectorsRequest) o;
