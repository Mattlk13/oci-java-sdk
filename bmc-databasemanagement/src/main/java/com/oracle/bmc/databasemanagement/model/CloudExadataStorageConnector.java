...
/**
 * The details of the Exadata storage server connector. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudExadataStorageConnector.Builder.class)
...
public final class CloudExadataStorageConnector extends DbmResource {
    ...
    public static class Builder {
        ...
        public CloudExadataStorageConnector build() {
            CloudExadataStorageConnector model =
                    new CloudExadataStorageConnector(
                            this.id,
                            this.displayName,
                            this.version,
                            this.internalId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudExadataStorageConnector model) {
    ...
    @Deprecated
    public CloudExadataStorageConnector(
            String id,
            String displayName,
            String version,
            String internalId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudExadataStorageConnector)) {
            return false;
        }

        CloudExadataStorageConnector other = (CloudExadataStorageConnector) o;
