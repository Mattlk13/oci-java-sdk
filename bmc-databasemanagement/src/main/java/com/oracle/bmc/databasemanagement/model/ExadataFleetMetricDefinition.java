...
/**
 * The Exadata infrastructure metric details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExadataFleetMetricDefinition.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ExadataFleetMetricDefinition
    ...
    public ExadataFleetMetricDefinition(
            String metricName,
    ...
    public static class Builder {
        ...
        public ExadataFleetMetricDefinition build() {
            ExadataFleetMetricDefinition model =
                    new ExadataFleetMetricDefinition(
                            this.metricName,
                            this.baselineValue,
                            this.targetValue,
                            this.unit,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExadataFleetMetricDefinition model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExadataFleetMetricDefinition(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExadataFleetMetricDefinition)) {
            return false;
        }

        ExadataFleetMetricDefinition other = (ExadataFleetMetricDefinition) o;
