...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudExadataStorageGrid.Builder.class)
...
public final class CloudExadataStorageGrid extends DbmResource {
    ...
    public static class Builder {
        ...
        private java.util.List<CloudExadataStorageServerSummary> storageServers;
        ...
        public Builder storageServers(
                java.util.List<CloudExadataStorageServerSummary> storageServers) {
        ...
        public CloudExadataStorageGrid build() {
            CloudExadataStorageGrid model =
                    new CloudExadataStorageGrid(
                            this.id,
                            this.displayName,
                            this.version,
                            this.internalId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudExadataStorageGrid model) {
    ...
    @Deprecated
    public CloudExadataStorageGrid(
            String id,
            String displayName,
            String version,
            String internalId,
    ...
    /** A list of monitored Exadata storage servers. */
    @com.fasterxml.jackson.annotation.JsonProperty("storageServers")
    private final java.util.List<CloudExadataStorageServerSummary> storageServers;
     ...
     * @return the value
     */
    public java.util.List<CloudExadataStorageServerSummary> getStorageServers() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudExadataStorageGrid(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudExadataStorageGrid)) {
            return false;
        }

        CloudExadataStorageGrid other = (CloudExadataStorageGrid) o;
