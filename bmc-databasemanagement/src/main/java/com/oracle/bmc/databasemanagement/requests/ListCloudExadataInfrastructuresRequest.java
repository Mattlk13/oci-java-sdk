...
public class ListCloudExadataInfrastructuresRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListCloudExadataInfrastructuresRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListCloudExadataInfrastructuresRequest o) {
        ...
        /**
         * Build the instance of ListCloudExadataInfrastructuresRequest as configured by this
         * builder
         *
         ...
         *
         * @return instance of ListCloudExadataInfrastructuresRequest
         */
        public ListCloudExadataInfrastructuresRequest build() {
            ListCloudExadataInfrastructuresRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCloudExadataInfrastructuresRequest
         */
        public ListCloudExadataInfrastructuresRequest buildWithoutInvocationCallback() {
            ListCloudExadataInfrastructuresRequest request =
                    new ListCloudExadataInfrastructuresRequest();
            ...
            return request;
            // new ListCloudExadataInfrastructuresRequest(compartmentId, displayName, page, limit,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCloudExadataInfrastructuresRequest)) {
            return false;
        }

        ListCloudExadataInfrastructuresRequest other = (ListCloudExadataInfrastructuresRequest) o;
