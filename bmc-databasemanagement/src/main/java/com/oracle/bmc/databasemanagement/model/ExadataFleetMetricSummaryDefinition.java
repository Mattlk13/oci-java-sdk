...
/**
 * A summary of the fleet metrics, which provides the metric aggregated value of the Exadata
 * infrastructures in the fleet. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExadataFleetMetricSummaryDefinition.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ExadataFleetMetricSummaryDefinition
    ...
    public ExadataFleetMetricSummaryDefinition(
            String metricName,
            Double baselineValue,
            Double targetValue,
            String unit,
            Double percentageChange,
            java.util.List<ExadataMetricDimensionDefinition> dimensions) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<ExadataMetricDimensionDefinition> dimensions;
         ...
         * @return this builder
         */
        public Builder dimensions(java.util.List<ExadataMetricDimensionDefinition> dimensions) {
            this.dimensions = dimensions;
        ...
        public ExadataFleetMetricSummaryDefinition build() {
            ExadataFleetMetricSummaryDefinition model =
                    new ExadataFleetMetricSummaryDefinition(
                            this.metricName,
                            this.baselineValue,
                            this.targetValue,
                            this.unit,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExadataFleetMetricSummaryDefinition model) {
    ...
    /** The unique dimension key and values of the baseline metric. */
    @com.fasterxml.jackson.annotation.JsonProperty("dimensions")
    private final java.util.List<ExadataMetricDimensionDefinition> dimensions;
     ...
     * @return the value
     */
    public java.util.List<ExadataMetricDimensionDefinition> getDimensions() {
        return dimensions;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExadataFleetMetricSummaryDefinition(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExadataFleetMetricSummaryDefinition)) {
            return false;
        }

        ExadataFleetMetricSummaryDefinition other = (ExadataFleetMetricSummaryDefinition) o;
