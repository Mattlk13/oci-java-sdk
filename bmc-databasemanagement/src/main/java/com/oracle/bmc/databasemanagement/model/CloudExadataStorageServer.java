...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudExadataStorageServer.Builder.class)
...
public final class CloudExadataStorageServer extends DbmResource {
    ...
    public static class Builder {
        ...
        private CloudExadataStorageConnectorSummary connector;

        public Builder connector(CloudExadataStorageConnectorSummary connector) {
        ...
        public CloudExadataStorageServer build() {
            CloudExadataStorageServer model =
                    new CloudExadataStorageServer(
                            this.id,
                            this.displayName,
                            this.version,
                            this.internalId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudExadataStorageServer model) {
    ...
    @Deprecated
    public CloudExadataStorageServer(
            String id,
            String displayName,
            String version,
            String internalId,
            ...
            CloudExadataStorageConnectorSummary connector,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("connector")
    private final CloudExadataStorageConnectorSummary connector;

    public CloudExadataStorageConnectorSummary getConnector() {
        return connector;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudExadataStorageServer(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudExadataStorageServer)) {
            return false;
        }

        CloudExadataStorageServer other = (CloudExadataStorageServer) o;
