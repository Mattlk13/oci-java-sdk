...
public class CheckCloudExadataStorageConnectorRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CheckCloudExadataStorageConnectorRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(CheckCloudExadataStorageConnectorRequest o) {
        ...
        /**
         * Build the instance of CheckCloudExadataStorageConnectorRequest as configured by this
         * builder
         *
         ...
         *
         * @return instance of CheckCloudExadataStorageConnectorRequest
         */
        public CheckCloudExadataStorageConnectorRequest build() {
            CheckCloudExadataStorageConnectorRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CheckCloudExadataStorageConnectorRequest
         */
        public CheckCloudExadataStorageConnectorRequest buildWithoutInvocationCallback() {
            CheckCloudExadataStorageConnectorRequest request =
                    new CheckCloudExadataStorageConnectorRequest();
            request.cloudExadataStorageConnectorId = cloudExadataStorageConnectorId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CheckCloudExadataStorageConnectorRequest(cloudExadataStorageConnectorId, ifMatch,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CheckCloudExadataStorageConnectorRequest)) {
            return false;
        }

        CheckCloudExadataStorageConnectorRequest other =
                (CheckCloudExadataStorageConnectorRequest) o;
