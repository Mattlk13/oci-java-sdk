...
/**
 * A summary of the inventory count grouped by Exadata infrastructure deployment type, and the
 * metrics that describe the aggregated usage of CPU, storage, and so on of all Exadata
