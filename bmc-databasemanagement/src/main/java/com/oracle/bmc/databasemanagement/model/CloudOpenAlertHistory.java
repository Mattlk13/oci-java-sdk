...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudOpenAlertHistory.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CloudOpenAlertHistory
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"alerts"})
    public CloudOpenAlertHistory(java.util.List<OpenAlertSummary> alerts) {
        super();
        this.alerts = alerts;
    }
    ...
    public static class Builder {
        ...
        public CloudOpenAlertHistory build() {
            CloudOpenAlertHistory model = new CloudOpenAlertHistory(this.alerts);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudOpenAlertHistory model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudOpenAlertHistory(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudOpenAlertHistory)) {
            return false;
        }

        CloudOpenAlertHistory other = (CloudOpenAlertHistory) o;
