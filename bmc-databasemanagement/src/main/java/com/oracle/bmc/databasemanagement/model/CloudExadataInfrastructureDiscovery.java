...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudExadataInfrastructureDiscovery.Builder.class)
...
public final class CloudExadataInfrastructureDiscovery extends EntityDiscovered {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("vmClusters")
        private java.util.List<VMClusterDiscoverySummary> vmClusters;

        /**
         * The list of VM Clusters in the Exadata infrastructure.
         *
         * @param vmClusters the value to set
         * @return this builder
         */
        public Builder vmClusters(java.util.List<VMClusterDiscoverySummary> vmClusters) {
            this.vmClusters = vmClusters;
            this.__explicitlySet__.add("vmClusters");
            return this;
        }

        @com.fasterxml.jackson.annotation.JsonProperty("storageGrid")
        private StorageGridDiscoverySummary storageGrid;

        public Builder storageGrid(StorageGridDiscoverySummary storageGrid) {
        ...
        private java.util.List<StorageServerDiscoverySummary> storageServers;
        ...
        public Builder storageServers(
                java.util.List<StorageServerDiscoverySummary> storageServers) {
        ...
        public CloudExadataInfrastructureDiscovery build() {
            CloudExadataInfrastructureDiscovery model =
                    new CloudExadataInfrastructureDiscovery(
                            this.id,
                            this.agentId,
                            this.connectorId,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudExadataInfrastructureDiscovery model) {
            ...
            if (model.wasPropertyExplicitlySet("vmClusters")) {
                this.vmClusters(model.getVmClusters());
            }
    ...
    @Deprecated
    public CloudExadataInfrastructureDiscovery(
            String id,
            String agentId,
            String connectorId,
            String displayName,
            ...
            RackSize rackSize,
            String gridHomePath,
            java.util.List<VMClusterDiscoverySummary> vmClusters,
            StorageGridDiscoverySummary storageGrid,
            java.util.List<StorageServerDiscoverySummary> storageServers) {
        super(
                id,
                agentId,
    ...
    /** The list of VM Clusters in the Exadata infrastructure. */
    @com.fasterxml.jackson.annotation.JsonProperty("vmClusters")
    private final java.util.List<VMClusterDiscoverySummary> vmClusters;
     ...
     * @return the value
     */
    public java.util.List<VMClusterDiscoverySummary> getVmClusters() {
        return vmClusters;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("storageGrid")
    private final StorageGridDiscoverySummary storageGrid;

    public StorageGridDiscoverySummary getStorageGrid() {
        return storageGrid;
    }

    /** The list of storage servers in the Exadata infrastructure. */
    @com.fasterxml.jackson.annotation.JsonProperty("storageServers")
    private final java.util.List<StorageServerDiscoverySummary> storageServers;
     ...
     * @return the value
     */
    public java.util.List<StorageServerDiscoverySummary> getStorageServers() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudExadataInfrastructureDiscovery(");
        ...
        sb.append(", vmClusters=").append(String.valueOf(this.vmClusters));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudExadataInfrastructureDiscovery)) {
            return false;
        }

        CloudExadataInfrastructureDiscovery other = (CloudExadataInfrastructureDiscovery) o;
        return java.util.Objects.equals(this.discoveryKey, other.discoveryKey)
                ...
                && java.util.Objects.equals(this.vmClusters, other.vmClusters)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.vmClusters == null ? 43 : this.vmClusters.hashCode());
