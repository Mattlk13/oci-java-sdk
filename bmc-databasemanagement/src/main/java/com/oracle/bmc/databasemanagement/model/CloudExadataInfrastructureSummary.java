...
public final class CloudExadataInfrastructureSummary extends DbmResource {
    ...
    public static class Builder {
        ...
        private CloudExadataInfrastructureDeploymentType infrastructureType;
        ...
        public Builder infrastructureType(
                CloudExadataInfrastructureDeploymentType infrastructureType) {
    ...
    /** The type of the Exadata infrastructure. */
    @com.fasterxml.jackson.annotation.JsonProperty("infrastructureType")
    private final CloudExadataInfrastructureDeploymentType infrastructureType;
