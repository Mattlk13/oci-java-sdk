...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudExadataStorageConnectorSummary.Builder.class)
...
public final class CloudExadataStorageConnectorSummary extends DbmResource {
    ...
    public static class Builder {
        ...
        public CloudExadataStorageConnectorSummary build() {
            CloudExadataStorageConnectorSummary model =
                    new CloudExadataStorageConnectorSummary(
                            this.id,
                            this.displayName,
                            this.version,
                            this.internalId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudExadataStorageConnectorSummary model) {
    ...
    @Deprecated
    public CloudExadataStorageConnectorSummary(
            String id,
            String displayName,
            String version,
            String internalId,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudExadataStorageConnectorSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudExadataStorageConnectorSummary)) {
            return false;
        }

        CloudExadataStorageConnectorSummary other = (CloudExadataStorageConnectorSummary) o;
