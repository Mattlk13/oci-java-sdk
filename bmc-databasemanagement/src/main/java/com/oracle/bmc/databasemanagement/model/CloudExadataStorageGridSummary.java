...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudExadataStorageGridSummary.Builder.class)
...
public final class CloudExadataStorageGridSummary extends DbmResource {
    ...
    public static class Builder {
        ...
        public CloudExadataStorageGridSummary build() {
            CloudExadataStorageGridSummary model =
                    new CloudExadataStorageGridSummary(
                            this.id,
                            this.displayName,
                            this.version,
                            this.internalId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudExadataStorageGridSummary model) {
    ...
    @Deprecated
    public CloudExadataStorageGridSummary(
            String id,
            String displayName,
            String version,
            String internalId,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudExadataStorageGridSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudExadataStorageGridSummary)) {
            return false;
        }

        CloudExadataStorageGridSummary other = (CloudExadataStorageGridSummary) o;
