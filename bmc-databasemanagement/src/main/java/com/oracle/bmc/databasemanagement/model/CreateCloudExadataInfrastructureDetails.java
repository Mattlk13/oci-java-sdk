...
/**
 * The details required to create the Exadata infrastructure. <br>
...
public final class CreateCloudExadataInfrastructureDetails
    ...
    public static class Builder {
         ...
         * If not specified, all the Exadata storage servers associated with the VM Clusters are
         * included.
         */
     ...
     * not specified, all the Exadata storage servers associated with the VM Clusters are included.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("storageServerNames")
