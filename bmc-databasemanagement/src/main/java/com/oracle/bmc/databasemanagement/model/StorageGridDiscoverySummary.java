...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StorageGridDiscoverySummary.Builder.class)
...
public final class StorageGridDiscoverySummary extends EntityDiscovered {
    ...
    public static class Builder {
        ...
        public StorageGridDiscoverySummary build() {
            StorageGridDiscoverySummary model =
                    new StorageGridDiscoverySummary(
                            this.id,
                            this.agentId,
                            this.connectorId,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StorageGridDiscoverySummary model) {
    ...
    @Deprecated
    public StorageGridDiscoverySummary(
            String id,
            String agentId,
            String connectorId,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StorageGridDiscoverySummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StorageGridDiscoverySummary)) {
            return false;
        }

        StorageGridDiscoverySummary other = (StorageGridDiscoverySummary) o;
