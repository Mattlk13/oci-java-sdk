...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExadataInfrastructureDiscoverySummary.Builder.class)
...
public final class ExadataInfrastructureDiscoverySummary extends EntityDiscovered {
    ...
    public static class Builder {
        ...
        public ExadataInfrastructureDiscoverySummary build() {
            ExadataInfrastructureDiscoverySummary model =
                    new ExadataInfrastructureDiscoverySummary(
                            this.id,
                            this.agentId,
                            this.connectorId,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExadataInfrastructureDiscoverySummary model) {
    ...
    @Deprecated
    public ExadataInfrastructureDiscoverySummary(
            String id,
            String agentId,
            String connectorId,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExadataInfrastructureDiscoverySummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExadataInfrastructureDiscoverySummary)) {
            return false;
        }

        ExadataInfrastructureDiscoverySummary other = (ExadataInfrastructureDiscoverySummary) o;
