...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExadataMetricDimensionDefinition.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ExadataMetricDimensionDefinition
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"dimensionName", "dimensionValue"})
    public ExadataMetricDimensionDefinition(String dimensionName, String dimensionValue) {
        super();
    ...
    public static class Builder {
        ...
        public ExadataMetricDimensionDefinition build() {
            ExadataMetricDimensionDefinition model =
                    new ExadataMetricDimensionDefinition(this.dimensionName, this.dimensionValue);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExadataMetricDimensionDefinition model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExadataMetricDimensionDefinition(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExadataMetricDimensionDefinition)) {
            return false;
        }

        ExadataMetricDimensionDefinition other = (ExadataMetricDimensionDefinition) o;
