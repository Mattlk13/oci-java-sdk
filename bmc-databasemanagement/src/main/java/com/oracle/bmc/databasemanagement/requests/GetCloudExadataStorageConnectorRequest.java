...
public class GetCloudExadataStorageConnectorRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetCloudExadataStorageConnectorRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetCloudExadataStorageConnectorRequest o) {
        ...
        /**
         * Build the instance of GetCloudExadataStorageConnectorRequest as configured by this
         * builder
         *
         ...
         *
         * @return instance of GetCloudExadataStorageConnectorRequest
         */
        public GetCloudExadataStorageConnectorRequest build() {
            GetCloudExadataStorageConnectorRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetCloudExadataStorageConnectorRequest
         */
        public GetCloudExadataStorageConnectorRequest buildWithoutInvocationCallback() {
            GetCloudExadataStorageConnectorRequest request =
                    new GetCloudExadataStorageConnectorRequest();
            request.cloudExadataStorageConnectorId = cloudExadataStorageConnectorId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetCloudExadataStorageConnectorRequest(cloudExadataStorageConnectorId,
            // opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetCloudExadataStorageConnectorRequest)) {
            return false;
        }

        GetCloudExadataStorageConnectorRequest other = (GetCloudExadataStorageConnectorRequest) o;
