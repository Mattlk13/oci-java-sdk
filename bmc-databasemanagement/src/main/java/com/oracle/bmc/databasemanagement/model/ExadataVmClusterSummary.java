...
/**
 * The VM Clusters of the Exadata infrastructure. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExadataVmClusterSummary.Builder.class)
...
public final class ExadataVmClusterSummary extends DbmResource {
    ...
    public static class Builder {
        ...
        public ExadataVmClusterSummary build() {
            ExadataVmClusterSummary model =
                    new ExadataVmClusterSummary(
                            this.id,
                            this.displayName,
                            this.version,
                            this.internalId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExadataVmClusterSummary model) {
    ...
    @Deprecated
    public ExadataVmClusterSummary(
            String id,
            String displayName,
            String version,
            String internalId,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExadataVmClusterSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExadataVmClusterSummary)) {
            return false;
        }

        ExadataVmClusterSummary other = (ExadataVmClusterSummary) o;
