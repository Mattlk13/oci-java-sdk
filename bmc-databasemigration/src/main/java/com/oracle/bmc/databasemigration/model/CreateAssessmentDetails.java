...
/**
 * Common Create Assessment details. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = CreateAssessmentDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreateOracleAssessmentDetails.class,
            name = "ORACLE"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreateMySqlAssessmentDetails.class,
            name = "MYSQL")
})
...
public class CreateAssessmentDetails
    ...
    protected CreateAssessmentDetails(
            String description,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAssessmentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAssessmentDetails)) {
            return false;
        }

        CreateAssessmentDetails other = (CreateAssessmentDetails) o;
