...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleAssessmentSummary.Builder.class)
...
public final class OracleAssessmentSummary extends AssessmentSummary {
    ...
    public static class Builder {
        ...
        public OracleAssessmentSummary build() {
            OracleAssessmentSummary model =
                    new OracleAssessmentSummary(
                            this.id,
                            this.displayName,
                            this.migrationId,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleAssessmentSummary model) {
    ...
    @Deprecated
    public OracleAssessmentSummary(
            String id,
            String displayName,
            String migrationId,
    ...
    /** True if CDB should be defined, false otherwise. */
    @com.fasterxml.jackson.annotation.JsonProperty("isCdbSupported")
    private final Boolean isCdbSupported;
     ...
     * @return the value
     */
    public Boolean getIsCdbSupported() {
        return isCdbSupported;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleAssessmentSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleAssessmentSummary)) {
            return false;
        }

        OracleAssessmentSummary other = (OracleAssessmentSummary) o;
