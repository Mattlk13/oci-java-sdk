...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MySqlMigrationSummary.Builder.class)
...
public final class MySqlMigrationSummary extends MigrationSummary {
    ...
    public static class Builder {
        ...
        public MySqlMigrationSummary build() {
            MySqlMigrationSummary model =
                    new MySqlMigrationSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.type,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MySqlMigrationSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MySqlMigrationSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MySqlMigrationSummary)) {
            return false;
        }

        MySqlMigrationSummary other = (MySqlMigrationSummary) o;
