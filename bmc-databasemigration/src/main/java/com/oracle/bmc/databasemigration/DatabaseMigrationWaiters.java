 ...
 * resources of DatabaseMigration.
 *
...
public class DatabaseMigrationWaiters {
    ...
    public DatabaseMigrationWaiters(
            java.util.concurrent.ExecutorService executorService, DatabaseMigration client) {
     ...
     */
    public com.oracle.bmc.waiter.Waiter<GetAssessmentRequest, GetAssessmentResponse> forAssessment(
            GetAssessmentRequest request,
            com.oracle.bmc.databasemigration.model.AssessmentLifecycleStates... targetStates) {
    ...
    public com.oracle.bmc.waiter.Waiter<GetAssessmentRequest, GetAssessmentResponse> forAssessment(
            GetAssessmentRequest request,
            com.oracle.bmc.databasemigration.model.AssessmentLifecycleStates targetState,
    ...
    // Helper method to create a new Waiter for Assessment.
    private com.oracle.bmc.waiter.Waiter<GetAssessmentRequest, GetAssessmentResponse> forAssessment(
            com.oracle.bmc.waiter.BmcGenericWaiter waiter,
            final GetAssessmentRequest request,
            final com.oracle.bmc.databasemigration.model.AssessmentLifecycleStates...
                    targetStates) {
        final java.util.Set<com.oracle.bmc.databasemigration.model.AssessmentLifecycleStates>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetAssessmentResponse apply(GetAssessmentRequest request) {
                                return client.getAssessment(request);
                            }
                        },
                        new java.util.function.Predicate<GetAssessmentResponse>() {
                            @Override
                            public boolean test(GetAssessmentResponse response) {
                                return targetStatesSet.contains(
                                        response.getAssessment().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
                                com.oracle.bmc.databasemigration.model.AssessmentLifecycleStates
                                        .Deleted)),
                request);
    }
     ...
     * @return a new {@code com.oracle.bmc.waiter.Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetAssessorRequest, GetAssessorResponse> forAssessor(
            GetAssessorRequest request,
            com.oracle.bmc.databasemigration.model.AssessorLifecycleStates... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetAssessorRequest, GetAssessorResponse> forAssessor(
            GetAssessorRequest request,
            com.oracle.bmc.databasemigration.model.AssessorLifecycleStates targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for Assessor.
    private com.oracle.bmc.waiter.Waiter<GetAssessorRequest, GetAssessorResponse> forAssessor(
            com.oracle.bmc.waiter.BmcGenericWaiter waiter,
            final GetAssessorRequest request,
            final com.oracle.bmc.databasemigration.model.AssessorLifecycleStates... targetStates) {
        final java.util.Set<com.oracle.bmc.databasemigration.model.AssessorLifecycleStates>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        () -> request,
                        new java.util.function.Function<GetAssessorRequest, GetAssessorResponse>() {
                            @Override
                            public GetAssessorResponse apply(GetAssessorRequest request) {
                                return client.getAssessor(request);
                            }
                        },
                        new java.util.function.Predicate<GetAssessorResponse>() {
                            @Override
                            public boolean test(GetAssessorResponse response) {
                                return targetStatesSet.contains(
                                        response.getAssessor().getLifecycleState());
                            }
                        },
                        false),
                request);
    ...
    // Helper method to create a new Waiter for Connection.
    ...
    public com.oracle.bmc.waiter.Waiter<GetJobRequest, GetJobResponse> forJob(
            ...
            com.oracle.bmc.databasemigration.model.JobLifecycleStates... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetJobRequest, GetJobResponse> forJob(
            GetJobRequest request,
            com.oracle.bmc.databasemigration.model.JobLifecycleStates targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    private com.oracle.bmc.waiter.Waiter<GetJobRequest, GetJobResponse> forJob(
            ...
            final com.oracle.bmc.databasemigration.model.JobLifecycleStates... targetStates) {
        final java.util.Set<com.oracle.bmc.databasemigration.model.JobLifecycleStates>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
