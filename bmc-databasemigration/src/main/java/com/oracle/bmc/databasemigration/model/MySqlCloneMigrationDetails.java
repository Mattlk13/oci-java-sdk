...
/**
 * MySQL Clone Migration Summary <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MySqlCloneMigrationDetails.Builder.class)
...
public final class MySqlCloneMigrationDetails extends CloneMigrationDetails {
    ...
    public static class Builder {
        ...
        public MySqlCloneMigrationDetails build() {
            MySqlCloneMigrationDetails model =
                    new MySqlCloneMigrationDetails(
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MySqlCloneMigrationDetails model) {
    ...
    @Deprecated
    public MySqlCloneMigrationDetails(
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MySqlCloneMigrationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MySqlCloneMigrationDetails)) {
            return false;
        }

        MySqlCloneMigrationDetails other = (MySqlCloneMigrationDetails) o;
