 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAssessorChecksRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230518")
public class ListAssessorChecksRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAssessorChecksRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAssessorChecksRequest o) {
        ...
        /**
         * Build the instance of ListAssessorChecksRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAssessorChecksRequest
         */
        public ListAssessorChecksRequest build() {
            ListAssessorChecksRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAssessorChecksRequest
         */
        public ListAssessorChecksRequest buildWithoutInvocationCallback() {
            ListAssessorChecksRequest request = new ListAssessorChecksRequest();
            ...
            return request;
            // new ListAssessorChecksRequest(assessmentId, compartmentId, assessorName,
            // opcRequestId, displayName, limit, page, sortBy, sortOrder);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAssessorChecksRequest)) {
            return false;
        }

        ListAssessorChecksRequest other = (ListAssessorChecksRequest) o;
