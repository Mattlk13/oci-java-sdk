...
/**
 * Update MySql Assessment resource parameters. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateMySqlAssessmentDetails.Builder.class)
...
public final class UpdateMySqlAssessmentDetails extends UpdateAssessmentDetails {
    ...
    public static class Builder {
        ...
        public UpdateMySqlAssessmentDetails build() {
            UpdateMySqlAssessmentDetails model =
                    new UpdateMySqlAssessmentDetails(
                            this.description,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateMySqlAssessmentDetails model) {
    ...
    @Deprecated
    public UpdateMySqlAssessmentDetails(
            String description,
            String displayName,
            NetworkSpeedMegabitPerSecond networkSpeedMegabitPerSecond,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateMySqlAssessmentDetails)) {
            return false;
        }
