...
/**
 * Update Oracle Assessment resource parameters. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateOracleAssessmentDetails.Builder.class)
...
public final class UpdateOracleAssessmentDetails extends UpdateAssessmentDetails {
    ...
    public static class Builder {
        ...
        public UpdateOracleAssessmentDetails build() {
            UpdateOracleAssessmentDetails model =
                    new UpdateOracleAssessmentDetails(
                            this.description,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOracleAssessmentDetails model) {
    ...
    @Deprecated
    public UpdateOracleAssessmentDetails(
            String description,
            String displayName,
            NetworkSpeedMegabitPerSecond networkSpeedMegabitPerSecond,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOracleAssessmentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOracleAssessmentDetails)) {
            return false;
        }

        UpdateOracleAssessmentDetails other = (UpdateOracleAssessmentDetails) o;
