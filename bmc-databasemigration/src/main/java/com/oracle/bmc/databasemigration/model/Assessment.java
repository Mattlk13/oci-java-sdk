...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = Assessment.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = MySqlAssessment.class,
            name = "MYSQL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = OracleAssessment.class,
            name = "ORACLE")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class Assessment extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    private final AssessmentLifecycleStates lifecycleState;
     ...
     * @return the value
     */
    public AssessmentLifecycleStates getLifecycleState() {
    ...
    private final AssessmentMigrationTypes assessmentMigrationType;
     ...
     * @return the value
     */
    public AssessmentMigrationTypes getAssessmentMigrationType() {
        return assessmentMigrationType;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", assessmentMigrationType=")
                .append(String.valueOf(this.assessmentMigrationType));
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(
                        this.assessmentMigrationType, other.assessmentMigrationType)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.assessmentMigrationType == null
                                ? 43
                                : this.assessmentMigrationType.hashCode());
