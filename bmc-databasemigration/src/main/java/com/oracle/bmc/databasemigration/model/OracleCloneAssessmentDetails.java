...
/**
 * Oracle Clone Assessment Summary <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleCloneAssessmentDetails.Builder.class)
...
public final class OracleCloneAssessmentDetails extends CloneAssessmentDetails {
    ...
    public static class Builder {
        ...
        public OracleCloneAssessmentDetails build() {
            OracleCloneAssessmentDetails model =
                    new OracleCloneAssessmentDetails(
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleCloneAssessmentDetails model) {
    ...
    @Deprecated
    public OracleCloneAssessmentDetails(
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleCloneAssessmentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleCloneAssessmentDetails)) {
            return false;
        }

        OracleCloneAssessmentDetails other = (OracleCloneAssessmentDetails) o;
