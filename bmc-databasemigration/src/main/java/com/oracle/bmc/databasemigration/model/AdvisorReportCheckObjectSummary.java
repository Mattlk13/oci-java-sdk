...
/**
 * Database objects to migration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AdvisorReportCheckObjectSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AdvisorReportCheckObjectSummary
    ...
    public AdvisorReportCheckObjectSummary(
    ...
    public static class Builder {
        ...
        public AdvisorReportCheckObjectSummary build() {
            AdvisorReportCheckObjectSummary model =
                    new AdvisorReportCheckObjectSummary(
                            this.fields,
                            this.isExcluded,
                            this.freeformTags,
                            this.definedTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdvisorReportCheckObjectSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdvisorReportCheckObjectSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdvisorReportCheckObjectSummary)) {
            return false;
        }

        AdvisorReportCheckObjectSummary other = (AdvisorReportCheckObjectSummary) o;
