...
/**
 * Customizable details when performing cloning of an Assessment. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = CloneAssessmentDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = MySqlCloneAssessmentDetails.class,
            name = "MYSQL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = OracleCloneAssessmentDetails.class,
            name = "ORACLE")
})
...
public class CloneAssessmentDetails
    ...
    protected CloneAssessmentDetails(
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloneAssessmentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloneAssessmentDetails)) {
            return false;
        }

        CloneAssessmentDetails other = (CloneAssessmentDetails) o;
