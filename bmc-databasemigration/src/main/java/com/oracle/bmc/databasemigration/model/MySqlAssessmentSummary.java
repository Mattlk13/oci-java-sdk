...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MySqlAssessmentSummary.Builder.class)
...
public final class MySqlAssessmentSummary extends AssessmentSummary {
    ...
    public static class Builder {
        ...
        public MySqlAssessmentSummary build() {
            MySqlAssessmentSummary model =
                    new MySqlAssessmentSummary(
                            this.id,
                            this.displayName,
                            this.migrationId,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MySqlAssessmentSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MySqlAssessmentSummary)) {
            return false;
        }
