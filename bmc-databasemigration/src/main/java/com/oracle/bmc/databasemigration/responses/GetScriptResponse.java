...
public class GetScriptResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetScriptResponse> {
         ...
         */
        @Override
        public Builder copy(GetScriptResponse o) {
        ...
        public GetScriptResponse build() {
            return new GetScriptResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, inputStream);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetScriptResponse)) {
            return false;
        }
