...
/**
 * MySQL Clone Assessment Summary <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MySqlCloneAssessmentDetails.Builder.class)
...
public final class MySqlCloneAssessmentDetails extends CloneAssessmentDetails {
    ...
    public static class Builder {
        ...
        public MySqlCloneAssessmentDetails build() {
            MySqlCloneAssessmentDetails model =
                    new MySqlCloneAssessmentDetails(
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MySqlCloneAssessmentDetails model) {
    ...
    @Deprecated
    public MySqlCloneAssessmentDetails(
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MySqlCloneAssessmentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MySqlCloneAssessmentDetails)) {
            return false;
        }

        MySqlCloneAssessmentDetails other = (MySqlCloneAssessmentDetails) o;
