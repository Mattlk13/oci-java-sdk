...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = OracleAssessment.Builder.class)
...
public final class OracleAssessment extends Assessment {
    ...
    public static class Builder {
        ...
        public OracleAssessment build() {
            OracleAssessment model =
                    new OracleAssessment(
                            this.id,
                            this.description,
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleAssessment model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleAssessment)) {
            return false;
        }
