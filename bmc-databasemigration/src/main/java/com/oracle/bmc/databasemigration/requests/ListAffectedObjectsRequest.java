 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAffectedObjectsRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230518")
public class ListAffectedObjectsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAffectedObjectsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAffectedObjectsRequest o) {
        ...
        /**
         * Build the instance of ListAffectedObjectsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAffectedObjectsRequest
         */
        public ListAffectedObjectsRequest build() {
            ListAffectedObjectsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAffectedObjectsRequest
         */
        public ListAffectedObjectsRequest buildWithoutInvocationCallback() {
            ListAffectedObjectsRequest request = new ListAffectedObjectsRequest();
            ...
            request.page = page;
            return request;
            // new ListAffectedObjectsRequest(assessmentId, assessorName, checkName, opcRequestId,
            // ifMatch, sortBy, sortOrder, limit, page);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAffectedObjectsRequest)) {
            return false;
        }

        ListAffectedObjectsRequest other = (ListAffectedObjectsRequest) o;
