...
public class ListAdvisorReportCheckObjectsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAdvisorReportCheckObjectsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAdvisorReportCheckObjectsRequest o) {
            jobId(o.getJobId());
        ...
        /**
         * Build the instance of ListAdvisorReportCheckObjectsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAdvisorReportCheckObjectsRequest
         */
        public ListAdvisorReportCheckObjectsRequest build() {
            ListAdvisorReportCheckObjectsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAdvisorReportCheckObjectsRequest
         */
        public ListAdvisorReportCheckObjectsRequest buildWithoutInvocationCallback() {
            ListAdvisorReportCheckObjectsRequest request =
                    new ListAdvisorReportCheckObjectsRequest();
            request.jobId = jobId;
            ...
            request.page = page;
            return request;
            // new ListAdvisorReportCheckObjectsRequest(jobId, advisorReportCheckId, opcRequestId,
            // limit, page);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAdvisorReportCheckObjectsRequest)) {
            return false;
        }

        ListAdvisorReportCheckObjectsRequest other = (ListAdvisorReportCheckObjectsRequest) o;
