...
/**
 * Summary of a Data Safe target database. <br>
...
public final class TargetDatabaseSummary
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TargetDatabaseSummary model) {
    ...
    /**
     * The date and time the database was registered in Data Safe and created as a target database
     * in Data Safe.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeCreated")
