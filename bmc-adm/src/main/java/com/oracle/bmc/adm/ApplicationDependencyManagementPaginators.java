...
public class ApplicationDependencyManagementPaginators {
     ...
     * listApplicationDependencyRecommendations operation. This iterable will fetch more data from
     ...
     * com.oracle.bmc.adm.model.ApplicationDependencyRecommendationSummary} objects contained in
     * responses from the listApplicationDependencyRecommendations operation. This iterable will
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listRemediationRecipes operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.adm.model.RemediationRecipeSummary} objects contained in responses from the
     * listRemediationRecipes operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.adm.model.RemediationRecipeSummary} objects contained in responses
     *     received from the service.
     */
    public Iterable<com.oracle.bmc.adm.model.RemediationRecipeSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                ListRemediationRecipesRequest,
                ListRemediationRecipesResponse,
                com.oracle.bmc.adm.model.RemediationRecipeSummary>(
                new java.util.function.Supplier<ListRemediationRecipesRequest.Builder>() {
                    @Override
                    public ListRemediationRecipesRequest.Builder get() {
                        return ListRemediationRecipesRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listRemediationRuns operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
     *     received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.adm.model.RemediationRunSummary} objects contained in responses from the
     * listRemediationRuns operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.adm.model.RemediationRunSummary} objects contained in responses received
     *     from the service.
     */
    public Iterable<com.oracle.bmc.adm.model.RemediationRunSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                ListRemediationRunsRequest,
                ListRemediationRunsResponse,
                com.oracle.bmc.adm.model.RemediationRunSummary>(
                new java.util.function.Supplier<ListRemediationRunsRequest.Builder>() {
                    @Override
                    public ListRemediationRunsRequest.Builder get() {
                        return ListRemediationRunsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.adm.model.RemediationRunStageSummary} objects contained in responses from the
     * listStages operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.adm.model.RemediationRunStageSummary} objects contained in responses
     *     received from the service.
     */
