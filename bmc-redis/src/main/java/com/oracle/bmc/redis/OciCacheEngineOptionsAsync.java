...
public interface OciCacheEngineOptionsAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<ListOciCacheEngineOptionsResponse> listOciCacheEngineOptions(
