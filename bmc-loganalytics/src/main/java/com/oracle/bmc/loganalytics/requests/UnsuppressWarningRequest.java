 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use UnsuppressWarningRequest.
 */
...
public class UnsuppressWarningRequest
    ...
    /** warnings list */
    public com.oracle.bmc.loganalytics.model.WarningReferenceDetails getWarningReferenceDetails() {
    ...
    public static class Builder
         ...
         * warnings list
         *
         * @param warningReferenceDetails the value to set
         * @return this builder instance
         */
        public Builder warningReferenceDetails(
                com.oracle.bmc.loganalytics.model.WarningReferenceDetails warningReferenceDetails) {
            this.warningReferenceDetails = warningReferenceDetails;
            return this;
        }
         ...
         * @return instance of UnsuppressWarningRequest
         */
        public UnsuppressWarningRequest buildWithoutInvocationCallback() {
            UnsuppressWarningRequest request = new UnsuppressWarningRequest();
            request.namespaceName = namespaceName;
            request.warningReferenceDetails = warningReferenceDetails;
            request.compartmentId = compartmentId;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new UnsuppressWarningRequest(namespaceName, warningReferenceDetails, compartmentId,
    ...
    public String toString() {
        ...
        sb.append(",warningReferenceDetails=").append(String.valueOf(this.warningReferenceDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnsuppressWarningRequest)) {
            return false;
        }

        UnsuppressWarningRequest other = (UnsuppressWarningRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.namespaceName, other.namespaceName)
                && java.util.Objects.equals(
                        this.warningReferenceDetails, other.warningReferenceDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.warningReferenceDetails == null
                                ? 43
                                : this.warningReferenceDetails.hashCode());
        result =
                (result * PRIME)
