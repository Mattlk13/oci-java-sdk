 ...
 * DisableIngestTimeRuleRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200601")
public class DisableIngestTimeRuleRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DisableIngestTimeRuleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DisableIngestTimeRuleRequest o) {
        ...
        /**
         * Build the instance of DisableIngestTimeRuleRequest as configured by this builder
         *
         ...
         *
         * @return instance of DisableIngestTimeRuleRequest
         */
        public DisableIngestTimeRuleRequest build() {
            DisableIngestTimeRuleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DisableIngestTimeRuleRequest
         */
        public DisableIngestTimeRuleRequest buildWithoutInvocationCallback() {
            DisableIngestTimeRuleRequest request = new DisableIngestTimeRuleRequest();
            request.namespaceName = namespaceName;
            request.ingestTimeRuleId = ingestTimeRuleId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DisableIngestTimeRuleRequest(namespaceName, ingestTimeRuleId, ifMatch,
            // opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisableIngestTimeRuleRequest)) {
            return false;
        }

        DisableIngestTimeRuleRequest other = (DisableIngestTimeRuleRequest) o;
