...
public class UpdatePreferencesRequest
    ...
    public static class Builder
        ...
        /** Details of the tenant preferences to update. */
        private com.oracle.bmc.loganalytics.model.LogAnalyticsPreferenceDetails
                updatePreferencesDetails = null;

        /**
         * Details of the tenant preferences to update.
         *
         * @param updatePreferencesDetails the value to set
         * @return this builder instance
         */
        public Builder updatePreferencesDetails(
                com.oracle.bmc.loganalytics.model.LogAnalyticsPreferenceDetails
                        updatePreferencesDetails) {
            this.updatePreferencesDetails = updatePreferencesDetails;
            return this;
        }
         ...
         * @return instance of UpdatePreferencesRequest
         */
        public UpdatePreferencesRequest buildWithoutInvocationCallback() {
            UpdatePreferencesRequest request = new UpdatePreferencesRequest();
            request.namespaceName = namespaceName;
            request.updatePreferencesDetails = updatePreferencesDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new UpdatePreferencesRequest(namespaceName, updatePreferencesDetails, opcRetryToken,
            // opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updatePreferencesDetails=")
                .append(String.valueOf(this.updatePreferencesDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePreferencesRequest)) {
            return false;
        }

        UpdatePreferencesRequest other = (UpdatePreferencesRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.namespaceName, other.namespaceName)
                && java.util.Objects.equals(
                        this.updatePreferencesDetails, other.updatePreferencesDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updatePreferencesDetails == null
                                ? 43
                                : this.updatePreferencesDetails.hashCode());
        result =
                (result * PRIME)
