 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ExportQueryResultRequest.
 */
...
public class ExportQueryResultRequest
    ...
    public static class Builder
        ...
        public Builder exportDetails(
                com.oracle.bmc.loganalytics.model.ExportDetails exportDetails) {
        ...
        /**
         * Build the instance of ExportQueryResultRequest as configured by this builder
         *
         ...
         *
         * @return instance of ExportQueryResultRequest
         */
        public ExportQueryResultRequest build() {
            ExportQueryResultRequest request = buildWithoutInvocationCallback();
        ...
        public ExportQueryResultRequest buildWithoutInvocationCallback() {
            ExportQueryResultRequest request = new ExportQueryResultRequest();
            request.namespaceName = namespaceName;
            request.exportDetails = exportDetails;
            request.opcRequestId = opcRequestId;
            return request;
            // new ExportQueryResultRequest(namespaceName, exportDetails, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExportQueryResultRequest)) {
            return false;
        }

        ExportQueryResultRequest other = (ExportQueryResultRequest) o;
