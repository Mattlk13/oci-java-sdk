 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetPreferencesRequest.
 */
...
public class GetPreferencesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of GetPreferencesRequest
         */
        public GetPreferencesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetPreferencesRequest(namespaceName, sortOrder, sortBy, limit, page,
            // opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPreferencesRequest)) {
            return false;
        }

        GetPreferencesRequest other = (GetPreferencesRequest) o;
