...
public class GetAssociationSummaryRequest
    ...
    public static class Builder
         ...
         * @return instance of GetAssociationSummaryRequest
         */
        public GetAssociationSummaryRequest buildWithoutInvocationCallback() {
            GetAssociationSummaryRequest request = new GetAssociationSummaryRequest();
            request.namespaceName = namespaceName;
            request.compartmentId = compartmentId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetAssociationSummaryRequest(namespaceName, compartmentId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAssociationSummaryRequest)) {
            return false;
        }

        GetAssociationSummaryRequest other = (GetAssociationSummaryRequest) o;
