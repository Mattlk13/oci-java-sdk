...
public class GetUnprocessedDataBucketRequest
    ...
    public static class Builder
        ...
        public GetUnprocessedDataBucketRequest buildWithoutInvocationCallback() {
            GetUnprocessedDataBucketRequest request = new GetUnprocessedDataBucketRequest();
            request.namespaceName = namespaceName;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetUnprocessedDataBucketRequest(namespaceName, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetUnprocessedDataBucketRequest)) {
            return false;
        }

        GetUnprocessedDataBucketRequest other = (GetUnprocessedDataBucketRequest) o;
