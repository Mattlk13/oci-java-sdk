...
public class ValidateAssociationParametersRequest
    ...
    public static class Builder
         ...
         * @return instance of ValidateAssociationParametersRequest
         */
        public ValidateAssociationParametersRequest buildWithoutInvocationCallback() {
            ValidateAssociationParametersRequest request =
                    new ValidateAssociationParametersRequest();
            ...
            return request;
            // new ValidateAssociationParametersRequest(namespaceName,
            // upsertLogAnalyticsAssociationDetails, limit, page, sortOrder, sortBy, opcRetryToken,
            // opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ValidateAssociationParametersRequest)) {
            return false;
        }

        ValidateAssociationParametersRequest other = (ValidateAssociationParametersRequest) o;
