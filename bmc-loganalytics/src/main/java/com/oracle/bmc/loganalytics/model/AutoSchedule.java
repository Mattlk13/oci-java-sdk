...
/**
 * Auto Fixed frequency schedule for a scheduled task. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AutoSchedule.Builder.class)
...
public final class AutoSchedule extends Schedule {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutoSchedule model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutoSchedule)) {
            return false;
        }

        AutoSchedule other = (AutoSchedule) o;
