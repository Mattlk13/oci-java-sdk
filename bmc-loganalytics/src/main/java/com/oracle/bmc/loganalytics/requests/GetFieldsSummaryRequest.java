 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetFieldsSummaryRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200601")
public class GetFieldsSummaryRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetFieldsSummaryRequest, java.lang.Void> {
        ...
        public Builder copy(GetFieldsSummaryRequest o) {
            ...
            isShowDetail(o.getIsShowDetail());
        ...
        /**
         * Build the instance of GetFieldsSummaryRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetFieldsSummaryRequest
         */
        public GetFieldsSummaryRequest build() {
            GetFieldsSummaryRequest request = buildWithoutInvocationCallback();
        ...
        public GetFieldsSummaryRequest buildWithoutInvocationCallback() {
            ...
            request.isShowDetail = isShowDetail;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetFieldsSummaryRequest(namespaceName, isShowDetail, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        GetFieldsSummaryRequest other = (GetFieldsSummaryRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.namespaceName, other.namespaceName)
                && java.util.Objects.equals(this.isShowDetail, other.isShowDetail)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.isShowDetail == null ? 43 : this.isShowDetail.hashCode());
