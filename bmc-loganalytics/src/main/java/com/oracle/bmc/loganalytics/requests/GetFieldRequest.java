 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetFieldRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200601")
public class GetFieldRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<GetFieldRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetFieldRequest
         */
        public GetFieldRequest build() {
            GetFieldRequest request = buildWithoutInvocationCallback();
        ...
        public GetFieldRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetFieldRequest(namespaceName, fieldName, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetFieldRequest)) {
            return false;
        }

        GetFieldRequest other = (GetFieldRequest) o;
