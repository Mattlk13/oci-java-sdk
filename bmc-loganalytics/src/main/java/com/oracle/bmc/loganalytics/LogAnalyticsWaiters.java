...
public class LogAnalyticsWaiters {
    ...
    public com.oracle.bmc.waiter.Waiter<GetNamespaceRequest, GetNamespaceResponse> forNamespace(
            ...
            com.oracle.bmc.loganalytics.model.Namespace.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetNamespaceRequest, GetNamespaceResponse> forNamespace(
            GetNamespaceRequest request,
            com.oracle.bmc.loganalytics.model.Namespace.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    private com.oracle.bmc.waiter.Waiter<GetNamespaceRequest, GetNamespaceResponse> forNamespace(
            ...
            final com.oracle.bmc.loganalytics.model.Namespace.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.loganalytics.model.Namespace.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Predicate<GetNamespaceResponse>() {
                            @Override
                            public boolean test(GetNamespaceResponse response) {
                                return targetStatesSet.contains(
