 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteSourceRequest.
 */
...
public class DeleteSourceRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteSourceRequest o) {
        ...
        /**
         * Build the instance of DeleteSourceRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteSourceRequest
         */
        public DeleteSourceRequest build() {
            DeleteSourceRequest request = buildWithoutInvocationCallback();
        ...
        public DeleteSourceRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteSourceRequest(namespaceName, sourceName, opcRetryToken, opcRequestId,
            // ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteSourceRequest)) {
            return false;
        }
