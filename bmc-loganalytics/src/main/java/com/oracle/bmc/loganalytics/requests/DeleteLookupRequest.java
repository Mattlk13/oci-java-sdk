 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteLookupRequest.
 */
...
public class DeleteLookupRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of DeleteLookupRequest
         */
        public DeleteLookupRequest buildWithoutInvocationCallback() {
            DeleteLookupRequest request = new DeleteLookupRequest();
            ...
            return request;
            // new DeleteLookupRequest(namespaceName, lookupName, isForce, opcRetryToken,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteLookupRequest)) {
            return false;
        }

        DeleteLookupRequest other = (DeleteLookupRequest) o;
