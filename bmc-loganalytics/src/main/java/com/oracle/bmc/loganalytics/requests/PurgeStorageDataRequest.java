 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use PurgeStorageDataRequest.
 */
...
public class PurgeStorageDataRequest
    ...
    /** This is the input to purge old data. */
    public com.oracle.bmc.loganalytics.model.PurgeStorageDataDetails getPurgeStorageDataDetails() {
    ...
    public static class Builder
         ...
         * This is the input to purge old data.
         *
         * @param purgeStorageDataDetails the value to set
         * @return this builder instance
         */
        public Builder purgeStorageDataDetails(
                com.oracle.bmc.loganalytics.model.PurgeStorageDataDetails purgeStorageDataDetails) {
            this.purgeStorageDataDetails = purgeStorageDataDetails;
            return this;
        }
         ...
         * @return instance of PurgeStorageDataRequest
         */
        public PurgeStorageDataRequest buildWithoutInvocationCallback() {
            PurgeStorageDataRequest request = new PurgeStorageDataRequest();
            request.namespaceName = namespaceName;
            request.purgeStorageDataDetails = purgeStorageDataDetails;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            return request;
            // new PurgeStorageDataRequest(namespaceName, purgeStorageDataDetails, opcRequestId,
    ...
    public String toString() {
        ...
        sb.append(",purgeStorageDataDetails=").append(String.valueOf(this.purgeStorageDataDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PurgeStorageDataRequest)) {
            return false;
        }

        PurgeStorageDataRequest other = (PurgeStorageDataRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.namespaceName, other.namespaceName)
                && java.util.Objects.equals(
                        this.purgeStorageDataDetails, other.purgeStorageDataDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.purgeStorageDataDetails == null
                                ? 43
                                : this.purgeStorageDataDetails.hashCode());
