 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateLookupRequest.
 */
...
public class UpdateLookupRequest
    ...
    public static class Builder
        ...
        public Builder updateLookupMetadataDetails(
                com.oracle.bmc.loganalytics.model.UpdateLookupMetadataDetails
                        updateLookupMetadataDetails) {
            this.updateLookupMetadataDetails = updateLookupMetadataDetails;
            return this;
        }
         ...
         * @return instance of UpdateLookupRequest
         */
        public UpdateLookupRequest buildWithoutInvocationCallback() {
            UpdateLookupRequest request = new UpdateLookupRequest();
            request.namespaceName = namespaceName;
            request.lookupName = lookupName;
            request.updateLookupMetadataDetails = updateLookupMetadataDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new UpdateLookupRequest(namespaceName, lookupName, updateLookupMetadataDetails,
    ...
    public String toString() {
        ...
        sb.append(",updateLookupMetadataDetails=")
                .append(String.valueOf(this.updateLookupMetadataDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateLookupRequest)) {
            return false;
        }

        UpdateLookupRequest other = (UpdateLookupRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.namespaceName, other.namespaceName)
                && java.util.Objects.equals(this.lookupName, other.lookupName)
                && java.util.Objects.equals(
                        this.updateLookupMetadataDetails, other.updateLookupMetadataDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateLookupMetadataDetails == null
                                ? 43
                                : this.updateLookupMetadataDetails.hashCode());
        result =
                (result * PRIME)
