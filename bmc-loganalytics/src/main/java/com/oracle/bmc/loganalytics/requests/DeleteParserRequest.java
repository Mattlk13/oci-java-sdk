 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteParserRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200601")
public class DeleteParserRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteParserRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteParserRequest o) {
        ...
        /**
         * Build the instance of DeleteParserRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteParserRequest
         */
        public DeleteParserRequest build() {
            DeleteParserRequest request = buildWithoutInvocationCallback();
        ...
        public DeleteParserRequest buildWithoutInvocationCallback() {
            DeleteParserRequest request = new DeleteParserRequest();
            ...
            return request;
            // new DeleteParserRequest(namespaceName, parserName, opcRetryToken, opcRequestId,
            // ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteParserRequest)) {
            return false;
        }

        DeleteParserRequest other = (DeleteParserRequest) o;
