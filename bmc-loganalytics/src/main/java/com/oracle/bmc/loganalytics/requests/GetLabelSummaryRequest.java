...
public class GetLabelSummaryRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetLabelSummaryRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetLabelSummaryRequest o) {
         ...
         *
         * @return instance of GetLabelSummaryRequest
         */
        public GetLabelSummaryRequest build() {
            GetLabelSummaryRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetLabelSummaryRequest
         */
        public GetLabelSummaryRequest buildWithoutInvocationCallback() {
            GetLabelSummaryRequest request = new GetLabelSummaryRequest();
            request.namespaceName = namespaceName;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetLabelSummaryRequest(namespaceName, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetLabelSummaryRequest)) {
            return false;
        }

        GetLabelSummaryRequest other = (GetLabelSummaryRequest) o;
