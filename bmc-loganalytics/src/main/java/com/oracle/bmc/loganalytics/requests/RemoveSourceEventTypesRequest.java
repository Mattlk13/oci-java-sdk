...
public class RemoveSourceEventTypesRequest
    ...
    public static class Builder
        ...
        public Builder removeEventTypeDetails(
                com.oracle.bmc.loganalytics.model.EventTypeDetails removeEventTypeDetails) {
        ...
        public Builder copy(RemoveSourceEventTypesRequest o) {
            ...
            removeEventTypeDetails(o.getRemoveEventTypeDetails());
        ...
        /**
         * Build the instance of RemoveSourceEventTypesRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveSourceEventTypesRequest
         */
        public RemoveSourceEventTypesRequest build() {
            RemoveSourceEventTypesRequest request = buildWithoutInvocationCallback();
        ...
        public RemoveSourceEventTypesRequest buildWithoutInvocationCallback() {
            ...
            request.removeEventTypeDetails = removeEventTypeDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new RemoveSourceEventTypesRequest(namespaceName, sourceName, removeEventTypeDetails,
    ...
    public String toString() {
        ...
        sb.append(",removeEventTypeDetails=").append(String.valueOf(this.removeEventTypeDetails));
    ...
    public boolean equals(Object o) {
        ...
        RemoveSourceEventTypesRequest other = (RemoveSourceEventTypesRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.namespaceName, other.namespaceName)
                && java.util.Objects.equals(this.sourceName, other.sourceName)
                && java.util.Objects.equals(
                        this.removeEventTypeDetails, other.removeEventTypeDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.removeEventTypeDetails == null
                                ? 43
                                : this.removeEventTypeDetails.hashCode());
        result =
                (result * PRIME)
