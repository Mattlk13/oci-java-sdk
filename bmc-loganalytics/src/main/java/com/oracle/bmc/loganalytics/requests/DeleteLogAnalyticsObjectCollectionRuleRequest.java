...
public class DeleteLogAnalyticsObjectCollectionRuleRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteLogAnalyticsObjectCollectionRuleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteLogAnalyticsObjectCollectionRuleRequest o) {
        ...
        /**
         * Build the instance of DeleteLogAnalyticsObjectCollectionRuleRequest as configured by this
         * builder
         *
         ...
         *
         * @return instance of DeleteLogAnalyticsObjectCollectionRuleRequest
         */
        public DeleteLogAnalyticsObjectCollectionRuleRequest build() {
         ...
         * @return instance of DeleteLogAnalyticsObjectCollectionRuleRequest
         */
        public DeleteLogAnalyticsObjectCollectionRuleRequest buildWithoutInvocationCallback() {
            DeleteLogAnalyticsObjectCollectionRuleRequest request =
                    new DeleteLogAnalyticsObjectCollectionRuleRequest();
            request.namespaceName = namespaceName;
            request.logAnalyticsObjectCollectionRuleId = logAnalyticsObjectCollectionRuleId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteLogAnalyticsObjectCollectionRuleRequest(namespaceName,
            // logAnalyticsObjectCollectionRuleId, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteLogAnalyticsObjectCollectionRuleRequest)) {
            return false;
        }

        DeleteLogAnalyticsObjectCollectionRuleRequest other =
                (DeleteLogAnalyticsObjectCollectionRuleRequest) o;
