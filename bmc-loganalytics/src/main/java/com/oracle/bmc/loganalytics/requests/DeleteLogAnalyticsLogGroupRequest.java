...
public class DeleteLogAnalyticsLogGroupRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteLogAnalyticsLogGroupRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteLogAnalyticsLogGroupRequest o) {
        ...
        /**
         * Build the instance of DeleteLogAnalyticsLogGroupRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteLogAnalyticsLogGroupRequest
         */
        public DeleteLogAnalyticsLogGroupRequest build() {
            DeleteLogAnalyticsLogGroupRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteLogAnalyticsLogGroupRequest
         */
        public DeleteLogAnalyticsLogGroupRequest buildWithoutInvocationCallback() {
            DeleteLogAnalyticsLogGroupRequest request = new DeleteLogAnalyticsLogGroupRequest();
            request.namespaceName = namespaceName;
            request.logAnalyticsLogGroupId = logAnalyticsLogGroupId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteLogAnalyticsLogGroupRequest(namespaceName, logAnalyticsLogGroupId, ifMatch,
            // opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteLogAnalyticsLogGroupRequest)) {
            return false;
        }

        DeleteLogAnalyticsLogGroupRequest other = (DeleteLogAnalyticsLogGroupRequest) o;
