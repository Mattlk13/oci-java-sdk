...
public class ExtractStructuredLogHeaderPathsRequest
    ...
    public static class Builder
        ...
        public ExtractStructuredLogHeaderPathsRequest buildWithoutInvocationCallback() {
            ExtractStructuredLogHeaderPathsRequest request =
                    new ExtractStructuredLogHeaderPathsRequest();
            ...
            return request;
            // new ExtractStructuredLogHeaderPathsRequest(namespaceName, loganParserDetails,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExtractStructuredLogHeaderPathsRequest)) {
            return false;
        }

        ExtractStructuredLogHeaderPathsRequest other = (ExtractStructuredLogHeaderPathsRequest) o;
