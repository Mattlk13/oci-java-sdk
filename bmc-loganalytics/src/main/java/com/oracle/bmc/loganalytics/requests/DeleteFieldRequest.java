 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteFieldRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200601")
public class DeleteFieldRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteFieldRequest, java.lang.Void> {
        ...
        /**
         * Build the instance of DeleteFieldRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteFieldRequest
         */
        public DeleteFieldRequest build() {
            DeleteFieldRequest request = buildWithoutInvocationCallback();
        ...
        public DeleteFieldRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteFieldRequest(namespaceName, fieldName, opcRetryToken, opcRequestId,
            // ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteFieldRequest)) {
            return false;
        }

        DeleteFieldRequest other = (DeleteFieldRequest) o;
