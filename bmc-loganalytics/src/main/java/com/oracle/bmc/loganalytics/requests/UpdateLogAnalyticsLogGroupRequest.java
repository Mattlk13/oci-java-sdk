...
public class UpdateLogAnalyticsLogGroupRequest
    ...
    public static class Builder
         ...
         * The information to be updated.
         *
         * @param updateLogAnalyticsLogGroupDetails the value to set
         * @return this builder instance
         */
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateLogAnalyticsLogGroupRequest o) {
            namespaceName(o.getNamespaceName());
            logAnalyticsLogGroupId(o.getLogAnalyticsLogGroupId());
            updateLogAnalyticsLogGroupDetails(o.getUpdateLogAnalyticsLogGroupDetails());
         ...
         */
        public UpdateLogAnalyticsLogGroupRequest build() {
            UpdateLogAnalyticsLogGroupRequest request = buildWithoutInvocationCallback();
        ...
        public UpdateLogAnalyticsLogGroupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateLogAnalyticsLogGroupRequest(namespaceName, logAnalyticsLogGroupId,
            // updateLogAnalyticsLogGroupDetails, ifMatch, opcRequestId);
        }
    }
