 ...
 * RemoveResourceCategoriesRequest.
 */
...
public class RemoveResourceCategoriesRequest
    ...
    private com.oracle.bmc.loganalytics.model.LogAnalyticsResourceCategoryDetails
            removeResourceCategoriesDetails;

    /** Details for removing the specified category assignments of resources. */
    public com.oracle.bmc.loganalytics.model.LogAnalyticsResourceCategoryDetails
            getRemoveResourceCategoriesDetails() {
        return removeResourceCategoriesDetails;
    }
    ...
    public static class Builder
        ...
        /** Details for removing the specified category assignments of resources. */
        private com.oracle.bmc.loganalytics.model.LogAnalyticsResourceCategoryDetails
                removeResourceCategoriesDetails = null;

        /**
         * Details for removing the specified category assignments of resources.
         *
         * @param removeResourceCategoriesDetails the value to set
         * @return this builder instance
         */
        public Builder removeResourceCategoriesDetails(
                com.oracle.bmc.loganalytics.model.LogAnalyticsResourceCategoryDetails
                        removeResourceCategoriesDetails) {
        ...
        public Builder copy(RemoveResourceCategoriesRequest o) {
            ...
            removeResourceCategoriesDetails(o.getRemoveResourceCategoriesDetails());
        ...
        /**
         * Build the instance of RemoveResourceCategoriesRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveResourceCategoriesRequest
         */
        public RemoveResourceCategoriesRequest build() {
            RemoveResourceCategoriesRequest request = buildWithoutInvocationCallback();
        ...
        public Builder body$(
            ...
            removeResourceCategoriesDetails(body);
            return this;
        }
        ...
        public RemoveResourceCategoriesRequest buildWithoutInvocationCallback() {
            ...
            request.removeResourceCategoriesDetails = removeResourceCategoriesDetails;
            request.opcRequestId = opcRequestId;
            return request;
            // new RemoveResourceCategoriesRequest(namespaceName, removeResourceCategoriesDetails,
            // opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder()
                ...
                .removeResourceCategoriesDetails(removeResourceCategoriesDetails)
    ...
    public String toString() {
        ...
        sb.append(",removeResourceCategoriesDetails=")
                .append(String.valueOf(this.removeResourceCategoriesDetails));
    ...
    public boolean equals(Object o) {
        ...
        RemoveResourceCategoriesRequest other = (RemoveResourceCategoriesRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.namespaceName, other.namespaceName)
                && java.util.Objects.equals(
                        this.removeResourceCategoriesDetails, other.removeResourceCategoriesDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.removeResourceCategoriesDetails == null
                                ? 43
                                : this.removeResourceCategoriesDetails.hashCode());
