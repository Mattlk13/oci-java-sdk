 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use EnableIngestTimeRuleRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200601")
public class EnableIngestTimeRuleRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    EnableIngestTimeRuleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(EnableIngestTimeRuleRequest o) {
        ...
        /**
         * Build the instance of EnableIngestTimeRuleRequest as configured by this builder
         *
         ...
         *
         * @return instance of EnableIngestTimeRuleRequest
         */
        public EnableIngestTimeRuleRequest build() {
            EnableIngestTimeRuleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of EnableIngestTimeRuleRequest
         */
        public EnableIngestTimeRuleRequest buildWithoutInvocationCallback() {
            EnableIngestTimeRuleRequest request = new EnableIngestTimeRuleRequest();
            request.namespaceName = namespaceName;
            request.ingestTimeRuleId = ingestTimeRuleId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new EnableIngestTimeRuleRequest(namespaceName, ingestTimeRuleId, ifMatch,
            // opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnableIngestTimeRuleRequest)) {
            return false;
        }

        EnableIngestTimeRuleRequest other = (EnableIngestTimeRuleRequest) o;
