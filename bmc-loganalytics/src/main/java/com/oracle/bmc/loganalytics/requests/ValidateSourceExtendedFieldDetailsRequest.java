...
public class ValidateSourceExtendedFieldDetailsRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(ValidateSourceExtendedFieldDetailsRequest o) {
        ...
        /**
         * Build the instance of ValidateSourceExtendedFieldDetailsRequest as configured by this
         * builder
         *
         ...
         *
         * @return instance of ValidateSourceExtendedFieldDetailsRequest
         */
        public ValidateSourceExtendedFieldDetailsRequest build() {
            ValidateSourceExtendedFieldDetailsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ValidateSourceExtendedFieldDetailsRequest
         */
        public ValidateSourceExtendedFieldDetailsRequest buildWithoutInvocationCallback() {
            ValidateSourceExtendedFieldDetailsRequest request =
                    new ValidateSourceExtendedFieldDetailsRequest();
            request.namespaceName = namespaceName;
            request.logAnalyticsSource = logAnalyticsSource;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new ValidateSourceExtendedFieldDetailsRequest(namespaceName, logAnalyticsSource,
    ...
    public String toString() {
        ...
        sb.append(",logAnalyticsSource=").append(String.valueOf(this.logAnalyticsSource));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ValidateSourceExtendedFieldDetailsRequest)) {
            return false;
        }

        ValidateSourceExtendedFieldDetailsRequest other =
                (ValidateSourceExtendedFieldDetailsRequest) o;
