 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use RemovePreferencesRequest.
 */
...
public class RemovePreferencesRequest
    ...
    /** Details of the tenant preferences to delete. */
    public com.oracle.bmc.loganalytics.model.LogAnalyticsPreferenceDetails
            getRemovePreferencesDetails() {
    ...
    public static class Builder
        ...
        /** Details of the tenant preferences to delete. */
        private com.oracle.bmc.loganalytics.model.LogAnalyticsPreferenceDetails
                removePreferencesDetails = null;

        /**
         * Details of the tenant preferences to delete.
         *
         * @param removePreferencesDetails the value to set
         * @return this builder instance
         */
        public Builder removePreferencesDetails(
                com.oracle.bmc.loganalytics.model.LogAnalyticsPreferenceDetails
                        removePreferencesDetails) {
            this.removePreferencesDetails = removePreferencesDetails;
            return this;
        }
         ...
         * @return instance of RemovePreferencesRequest
         */
        public RemovePreferencesRequest buildWithoutInvocationCallback() {
            RemovePreferencesRequest request = new RemovePreferencesRequest();
            request.namespaceName = namespaceName;
            request.removePreferencesDetails = removePreferencesDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new RemovePreferencesRequest(namespaceName, removePreferencesDetails, opcRetryToken,
            // opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder()
                ...
                .removePreferencesDetails(removePreferencesDetails)
    ...
    public String toString() {
        ...
        sb.append(",removePreferencesDetails=")
                .append(String.valueOf(this.removePreferencesDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemovePreferencesRequest)) {
            return false;
        }

        RemovePreferencesRequest other = (RemovePreferencesRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.namespaceName, other.namespaceName)
                && java.util.Objects.equals(
                        this.removePreferencesDetails, other.removePreferencesDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.removePreferencesDetails == null
                                ? 43
                                : this.removePreferencesDetails.hashCode());
        result =
                (result * PRIME)
