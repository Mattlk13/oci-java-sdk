...
public class ListEntityAssociationsRequest
     ...
     * entities.
     */
    public enum DirectOrAllAssociations implements com.oracle.bmc.http.internal.BmcEnum {
        Direct("DIRECT"),
        All("ALL"),
        ;

        private final String value;
        private static java.util.Map<String, DirectOrAllAssociations> map;
        ...
        DirectOrAllAssociations(String value) {
            this.value = value;
        }
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListEntityAssociationsRequest, java.lang.Void> {
        ...
        public Builder copy(ListEntityAssociationsRequest o) {
            ...
            directOrAllAssociations(o.getDirectOrAllAssociations());
            limit(o.getLimit());
            page(o.getPage());
         ...
         *
         * @return instance of ListEntityAssociationsRequest
         */
        public ListEntityAssociationsRequest build() {
            ListEntityAssociationsRequest request = buildWithoutInvocationCallback();
        ...
        public ListEntityAssociationsRequest buildWithoutInvocationCallback() {
            ListEntityAssociationsRequest request = new ListEntityAssociationsRequest();
            request.namespaceName = namespaceName;
            request.logAnalyticsEntityId = logAnalyticsEntityId;
            request.directOrAllAssociations = directOrAllAssociations;
            request.limit = limit;
            request.page = page;
            ...
            return request;
            // new ListEntityAssociationsRequest(namespaceName, logAnalyticsEntityId,
            // directOrAllAssociations, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",directOrAllAssociations=").append(String.valueOf(this.directOrAllAssociations));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListEntityAssociationsRequest)) {
            return false;
        }

        ListEntityAssociationsRequest other = (ListEntityAssociationsRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.namespaceName, other.namespaceName)
                && java.util.Objects.equals(this.logAnalyticsEntityId, other.logAnalyticsEntityId)
                && java.util.Objects.equals(
                        this.directOrAllAssociations, other.directOrAllAssociations)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.directOrAllAssociations == null
                                ? 43
                                : this.directOrAllAssociations.hashCode());
