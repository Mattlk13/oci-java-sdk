 ...
 * CancelQueryWorkRequestRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200601")
public class CancelQueryWorkRequestRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CancelQueryWorkRequestRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(CancelQueryWorkRequestRequest o) {
        ...
        /**
         * Build the instance of CancelQueryWorkRequestRequest as configured by this builder
         *
         ...
         *
         * @return instance of CancelQueryWorkRequestRequest
         */
        public CancelQueryWorkRequestRequest build() {
            CancelQueryWorkRequestRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CancelQueryWorkRequestRequest
         */
        public CancelQueryWorkRequestRequest buildWithoutInvocationCallback() {
            CancelQueryWorkRequestRequest request = new CancelQueryWorkRequestRequest();
            request.namespaceName = namespaceName;
            request.workRequestId = workRequestId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new CancelQueryWorkRequestRequest(namespaceName, workRequestId, opcRequestId,
            // ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CancelQueryWorkRequestRequest)) {
            return false;
        }

        CancelQueryWorkRequestRequest other = (CancelQueryWorkRequestRequest) o;
