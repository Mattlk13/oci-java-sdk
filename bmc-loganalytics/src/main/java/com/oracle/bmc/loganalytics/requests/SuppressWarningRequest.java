...
public class SuppressWarningRequest
    ...
    public static class Builder
         ...
         * @return instance of SuppressWarningRequest
         */
        public SuppressWarningRequest buildWithoutInvocationCallback() {
            SuppressWarningRequest request = new SuppressWarningRequest();
            ...
            return request;
            // new SuppressWarningRequest(namespaceName, warningReferenceDetails, compartmentId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SuppressWarningRequest)) {
            return false;
        }

        SuppressWarningRequest other = (SuppressWarningRequest) o;
