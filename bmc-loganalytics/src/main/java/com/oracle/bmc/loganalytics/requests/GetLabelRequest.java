 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetLabelRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200601")
public class GetLabelRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<GetLabelRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetLabelRequest o) {
         ...
         *
         * @return instance of GetLabelRequest
         */
        public GetLabelRequest build() {
            GetLabelRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetLabelRequest
         */
        public GetLabelRequest buildWithoutInvocationCallback() {
            GetLabelRequest request = new GetLabelRequest();
            request.namespaceName = namespaceName;
            request.labelName = labelName;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetLabelRequest(namespaceName, labelName, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetLabelRequest)) {
            return false;
        }

        GetLabelRequest other = (GetLabelRequest) o;
