...
public final class LogAnalyticsSource
    ...
    public static class Builder {
        ...
        /**
         * An array of categories assigned to this source. The isSystem flag denotes if each
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LogAnalyticsSource model) {
            ...
            if (model.wasPropertyExplicitlySet("eventTypes")) {
    ...
    /**
     * An array of categories assigned to this source. The isSystem flag denotes if each category
