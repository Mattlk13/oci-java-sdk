...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/ListTemplatesExample.java.html"
...
public class ListTemplatesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * The template lifecycle state used for filtering. Currently supported values are ACTIVE and
     * DELETED.
     */
    ...
    public static class Builder
        ...
        /**
         * The template type used for filtering. Only templates of the specified type will be
         * returned.
         */
         ...
         * description will be returned.
         */
        private String templateDisplayText = null;

        /**
         * The template display text used for filtering. Only templates with the specified name or
         * description will be returned.
         *
         * @param templateDisplayText the value to set
         * @return this builder instance
         */
        ...
        /**
         * The template lifecycle state used for filtering. Currently supported values are ACTIVE
         * and DELETED.
         */
        ...
        public Builder copy(ListTemplatesRequest o) {
            ...
            type(o.getType());
            name(o.getName());
            templateDisplayText(o.getTemplateDisplayText());
        ...
        public ListTemplatesRequest buildWithoutInvocationCallback() {
            ...
            request.type = type;
            request.name = name;
            request.templateDisplayText = templateDisplayText;
            ...
            return request;
            // new ListTemplatesRequest(namespaceName, compartmentId, type, name,
            // templateDisplayText, lifecycleState, filter, limit, page, sortOrder, sortBy,
            // opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",templateDisplayText=").append(String.valueOf(this.templateDisplayText));
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.templateDisplayText, other.templateDisplayText)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.templateDisplayText == null
                                ? 43
                                : this.templateDisplayText.hashCode());
        result =
                (result * PRIME)
