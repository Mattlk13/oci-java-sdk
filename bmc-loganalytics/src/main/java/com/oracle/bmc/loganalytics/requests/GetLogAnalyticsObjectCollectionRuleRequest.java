...
public class GetLogAnalyticsObjectCollectionRuleRequest
    ...
    public static class Builder
         ...
         */
        public GetLogAnalyticsObjectCollectionRuleRequest build() {
            GetLogAnalyticsObjectCollectionRuleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetLogAnalyticsObjectCollectionRuleRequest
         */
        public GetLogAnalyticsObjectCollectionRuleRequest buildWithoutInvocationCallback() {
            GetLogAnalyticsObjectCollectionRuleRequest request =
                    new GetLogAnalyticsObjectCollectionRuleRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetLogAnalyticsObjectCollectionRuleRequest)) {
            return false;
        }

        GetLogAnalyticsObjectCollectionRuleRequest other =
                (GetLogAnalyticsObjectCollectionRuleRequest) o;
