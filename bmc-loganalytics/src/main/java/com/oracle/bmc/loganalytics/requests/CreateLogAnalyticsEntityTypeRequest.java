...
public class CreateLogAnalyticsEntityTypeRequest
    ...
    public static class Builder
        ...
        public Builder createLogAnalyticsEntityTypeDetails(
                com.oracle.bmc.loganalytics.model.CreateLogAnalyticsEntityTypeDetails
                        createLogAnalyticsEntityTypeDetails) {
            this.createLogAnalyticsEntityTypeDetails = createLogAnalyticsEntityTypeDetails;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(CreateLogAnalyticsEntityTypeRequest o) {
            namespaceName(o.getNamespaceName());
            createLogAnalyticsEntityTypeDetails(o.getCreateLogAnalyticsEntityTypeDetails());
        ...
        /**
         * Build the instance of CreateLogAnalyticsEntityTypeRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateLogAnalyticsEntityTypeRequest
         */
        public CreateLogAnalyticsEntityTypeRequest build() {
            CreateLogAnalyticsEntityTypeRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateLogAnalyticsEntityTypeRequest
         */
        public CreateLogAnalyticsEntityTypeRequest buildWithoutInvocationCallback() {
            CreateLogAnalyticsEntityTypeRequest request = new CreateLogAnalyticsEntityTypeRequest();
            request.namespaceName = namespaceName;
            request.createLogAnalyticsEntityTypeDetails = createLogAnalyticsEntityTypeDetails;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateLogAnalyticsEntityTypeRequest(namespaceName,
            // createLogAnalyticsEntityTypeDetails, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createLogAnalyticsEntityTypeDetails=")
                .append(String.valueOf(this.createLogAnalyticsEntityTypeDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateLogAnalyticsEntityTypeRequest)) {
            return false;
        }

        CreateLogAnalyticsEntityTypeRequest other = (CreateLogAnalyticsEntityTypeRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.namespaceName, other.namespaceName)
                && java.util.Objects.equals(
                        this.createLogAnalyticsEntityTypeDetails,
                        other.createLogAnalyticsEntityTypeDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createLogAnalyticsEntityTypeDetails == null
                                ? 43
                                : this.createLogAnalyticsEntityTypeDetails.hashCode());
