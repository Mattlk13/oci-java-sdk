...
public class GetConfigWorkRequestRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetConfigWorkRequestRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetConfigWorkRequestRequest o) {
        ...
        /**
         * Build the instance of GetConfigWorkRequestRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetConfigWorkRequestRequest
         */
        public GetConfigWorkRequestRequest build() {
            GetConfigWorkRequestRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetConfigWorkRequestRequest
         */
        public GetConfigWorkRequestRequest buildWithoutInvocationCallback() {
            GetConfigWorkRequestRequest request = new GetConfigWorkRequestRequest();
            request.namespaceName = namespaceName;
            request.workRequestId = workRequestId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetConfigWorkRequestRequest(namespaceName, workRequestId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetConfigWorkRequestRequest)) {
            return false;
        }

        GetConfigWorkRequestRequest other = (GetConfigWorkRequestRequest) o;
