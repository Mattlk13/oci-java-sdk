 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use CompareContentRequest.
 */
...
public class CompareContentRequest
    ...
    public com.oracle.bmc.loganalytics.model.CompareContentDetails getBody$() {
        return compareContentDetails;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(CompareContentRequest o) {
            namespaceName(o.getNamespaceName());
            compareContentDetails(o.getCompareContentDetails());
         ...
         */
        public CompareContentRequest build() {
            CompareContentRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.loganalytics.model.CompareContentDetails body) {
