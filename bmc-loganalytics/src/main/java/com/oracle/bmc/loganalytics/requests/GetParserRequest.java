 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetParserRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200601")
public class GetParserRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetParserRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetParserRequest
         */
        public GetParserRequest build() {
            GetParserRequest request = buildWithoutInvocationCallback();
        ...
        public GetParserRequest buildWithoutInvocationCallback() {
            GetParserRequest request = new GetParserRequest();
            request.namespaceName = namespaceName;
            request.parserName = parserName;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetParserRequest(namespaceName, parserName, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetParserRequest)) {
            return false;
        }

        GetParserRequest other = (GetParserRequest) o;
