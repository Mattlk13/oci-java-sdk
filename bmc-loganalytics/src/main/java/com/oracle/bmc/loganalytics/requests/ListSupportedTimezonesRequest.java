...
public class ListSupportedTimezonesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListSupportedTimezonesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListSupportedTimezonesRequest o) {
         ...
         */
        public ListSupportedTimezonesRequest build() {
            ListSupportedTimezonesRequest request = buildWithoutInvocationCallback();
