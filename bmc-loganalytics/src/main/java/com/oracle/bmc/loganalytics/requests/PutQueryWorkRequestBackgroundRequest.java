...
public class PutQueryWorkRequestBackgroundRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PutQueryWorkRequestBackgroundRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(PutQueryWorkRequestBackgroundRequest o) {
        ...
        /**
         * Build the instance of PutQueryWorkRequestBackgroundRequest as configured by this builder
         *
         ...
         *
         * @return instance of PutQueryWorkRequestBackgroundRequest
         */
        public PutQueryWorkRequestBackgroundRequest build() {
            PutQueryWorkRequestBackgroundRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PutQueryWorkRequestBackgroundRequest
         */
        public PutQueryWorkRequestBackgroundRequest buildWithoutInvocationCallback() {
            PutQueryWorkRequestBackgroundRequest request =
                    new PutQueryWorkRequestBackgroundRequest();
            request.namespaceName = namespaceName;
            request.workRequestId = workRequestId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new PutQueryWorkRequestBackgroundRequest(namespaceName, workRequestId, opcRequestId,
            // ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutQueryWorkRequestBackgroundRequest)) {
            return false;
        }

        PutQueryWorkRequestBackgroundRequest other = (PutQueryWorkRequestBackgroundRequest) o;
