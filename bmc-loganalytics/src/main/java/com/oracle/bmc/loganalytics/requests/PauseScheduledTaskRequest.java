 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use PauseScheduledTaskRequest.
 */
...
public class PauseScheduledTaskRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public PauseScheduledTaskRequest buildWithoutInvocationCallback() {
            PauseScheduledTaskRequest request = new PauseScheduledTaskRequest();
            request.namespaceName = namespaceName;
            request.scheduledTaskId = scheduledTaskId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new PauseScheduledTaskRequest(namespaceName, scheduledTaskId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PauseScheduledTaskRequest)) {
            return false;
        }

        PauseScheduledTaskRequest other = (PauseScheduledTaskRequest) o;
