...
public class DeleteLogAnalyticsEntityTypeRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteLogAnalyticsEntityTypeRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteLogAnalyticsEntityTypeRequest o) {
        ...
        /**
         * Build the instance of DeleteLogAnalyticsEntityTypeRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteLogAnalyticsEntityTypeRequest
         */
        public DeleteLogAnalyticsEntityTypeRequest build() {
            DeleteLogAnalyticsEntityTypeRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteLogAnalyticsEntityTypeRequest
         */
        public DeleteLogAnalyticsEntityTypeRequest buildWithoutInvocationCallback() {
            DeleteLogAnalyticsEntityTypeRequest request = new DeleteLogAnalyticsEntityTypeRequest();
            request.namespaceName = namespaceName;
            request.entityTypeName = entityTypeName;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteLogAnalyticsEntityTypeRequest(namespaceName, entityTypeName, ifMatch,
            // opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteLogAnalyticsEntityTypeRequest)) {
            return false;
        }

        DeleteLogAnalyticsEntityTypeRequest other = (DeleteLogAnalyticsEntityTypeRequest) o;
