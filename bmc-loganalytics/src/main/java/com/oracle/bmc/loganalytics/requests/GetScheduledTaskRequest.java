...
public class GetScheduledTaskRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         */
        public GetScheduledTaskRequest build() {
            GetScheduledTaskRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetScheduledTaskRequest
         */
        public GetScheduledTaskRequest buildWithoutInvocationCallback() {
            GetScheduledTaskRequest request = new GetScheduledTaskRequest();
            request.namespaceName = namespaceName;
            request.scheduledTaskId = scheduledTaskId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetScheduledTaskRequest(namespaceName, scheduledTaskId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetScheduledTaskRequest)) {
            return false;
        }

        GetScheduledTaskRequest other = (GetScheduledTaskRequest) o;
