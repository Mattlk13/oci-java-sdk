 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetUploadRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200601")
public class GetUploadRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetUploadRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetUploadRequest
         */
        public GetUploadRequest build() {
            GetUploadRequest request = buildWithoutInvocationCallback();
        ...
        public GetUploadRequest buildWithoutInvocationCallback() {
            GetUploadRequest request = new GetUploadRequest();
            request.namespaceName = namespaceName;
            request.uploadReference = uploadReference;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetUploadRequest(namespaceName, uploadReference, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetUploadRequest)) {
            return false;
        }

        GetUploadRequest other = (GetUploadRequest) o;
