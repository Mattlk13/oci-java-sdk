...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GdpWorkRequestSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class GdpWorkRequestSummary
    ...
    public static class Builder {
        ...
        public GdpWorkRequestSummary build() {
            GdpWorkRequestSummary model =
                    new GdpWorkRequestSummary(
                            this.operationType,
                            this.status,
                            this.id,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GdpWorkRequestSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GdpWorkRequestSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GdpWorkRequestSummary)) {
            return false;
        }

        GdpWorkRequestSummary other = (GdpWorkRequestSummary) o;
