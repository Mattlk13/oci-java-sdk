...
public interface GuardedDataPipelineAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<ChangeGdpPipelineCompartmentResponse> changeGdpPipelineCompartment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateGdpPipelineResponse> createGdpPipeline(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteGdpPipelineResponse> deleteGdpPipeline(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetGdpPipelineResponse> getGdpPipeline(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetGdpWorkRequestResponse> getGdpWorkRequest(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListGdpPipelinesResponse> listGdpPipelines(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListGdpWorkRequestErrorsResponse> listGdpWorkRequestErrors(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListGdpWorkRequestLogsResponse> listGdpWorkRequestLogs(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListGdpWorkRequestsResponse> listGdpWorkRequests(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<PeerGdpPipelineResponse> peerGdpPipeline(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<RotateGdpPipelineKeysResponse> rotateGdpPipelineKeys(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<StartGdpPipelineResponse> startGdpPipeline(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<StopGdpPipelineResponse> stopGdpPipeline(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateGdpPipelineResponse> updateGdpPipeline(
