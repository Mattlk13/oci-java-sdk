...
public class ListManagementSavedSearchesRequest
    ...
    public static class Builder
         ...
         * @return instance of ListManagementSavedSearchesRequest
         */
        public ListManagementSavedSearchesRequest buildWithoutInvocationCallback() {
            ListManagementSavedSearchesRequest request = new ListManagementSavedSearchesRequest();
            ...
            return request;
            // new ListManagementSavedSearchesRequest(compartmentId, displayName, opcRequestId,
            // limit, page, sortOrder, sortBy, compartmentIdInSubtree);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListManagementSavedSearchesRequest)) {
            return false;
        }

        ListManagementSavedSearchesRequest other = (ListManagementSavedSearchesRequest) o;
