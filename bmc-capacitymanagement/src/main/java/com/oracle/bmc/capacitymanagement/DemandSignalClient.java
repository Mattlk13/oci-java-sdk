...
public class DemandSignalClient extends com.oracle.bmc.http.internal.BaseSyncClient
        implements DemandSignal {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(DemandSignalClient.class);

    private final DemandSignalWaiters waiters;

    private final DemandSignalPaginators paginators;
            ...
            java.util.concurrent.ThreadPoolExecutor threadPoolExecutor =
                    new java.util.concurrent.ThreadPoolExecutor(
                            ...
                            com.oracle.bmc.internal.ClientThreadFactory.builder()
                                    .isDaemon(true)
                                    .nameFormat("DemandSignal-waiters-%d")
                                    .build());
            threadPoolExecutor.allowCoreThreadTimeOut(true);

            executorService = threadPoolExecutor;
        }
        this.waiters = new DemandSignalWaiters(executorService, this);

        this.paginators = new DemandSignalPaginators(this);
    }
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, DemandSignalClient> {
         ...
         * @return the client
         */
        public DemandSignalClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new DemandSignalClient(this, authenticationDetailsProvider, executorService);
        }
    }
    ...
    @Override
    public BulkCreateOccmDemandSignalItemResponse bulkCreateOccmDemandSignalItem(
    ...
    @Override
    public CreateOccmDemandSignalResponse createOccmDemandSignal(
    ...
    @Override
    public CreateOccmDemandSignalItemResponse createOccmDemandSignalItem(
    ...
    @Override
    public DeleteOccmDemandSignalResponse deleteOccmDemandSignal(
    ...
    @Override
    public DeleteOccmDemandSignalItemResponse deleteOccmDemandSignalItem(
    ...
    @Override
    public GetOccmDemandSignalItemResponse getOccmDemandSignalItem(
    ...
    @Override
    public ListOccmDemandSignalCatalogResourcesResponse listOccmDemandSignalCatalogResources(
    ...
    @Override
    public ListOccmDemandSignalDeliveriesResponse listOccmDemandSignalDeliveries(
    ...
    @Override
    public ListOccmDemandSignalItemsResponse listOccmDemandSignalItems(
    ...
    @Override
    public ListOccmDemandSignalsResponse listOccmDemandSignals(
    ...
    @Override
    public UpdateOccmDemandSignalResponse updateOccmDemandSignal(
    ...
    @Override
    public UpdateOccmDemandSignalItemResponse updateOccmDemandSignalItem(
