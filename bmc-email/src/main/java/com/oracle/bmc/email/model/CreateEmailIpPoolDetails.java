...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateEmailIpPoolDetails.Builder.class)
...
public final class CreateEmailIpPoolDetails
    ...
    public CreateEmailIpPoolDetails(
            String name,
    ...
    public static class Builder {
        ...
        /**
         * A list of outbound public IPs for assignment to the IpPool. These IPs must be in the
         * AVAILABLE state to be eligible for assignment.
         */
        ...
        public CreateEmailIpPoolDetails build() {
            CreateEmailIpPoolDetails model =
                    new CreateEmailIpPoolDetails(
                            this.name,
                            this.compartmentId,
                            this.description,
                            this.outboundIps,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateEmailIpPoolDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateEmailIpPoolDetails)) {
            return false;
        }

        CreateEmailIpPoolDetails other = (CreateEmailIpPoolDetails) o;
