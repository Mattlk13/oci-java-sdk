...
public class CreateChargebackPlanResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateChargebackPlanResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateChargebackPlanResponse> {
         ...
         */
        @Override
        public Builder copy(CreateChargebackPlanResponse o) {
         ...
         */
        @Override
        public CreateChargebackPlanResponse build() {
            return new CreateChargebackPlanResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateChargebackPlanResponse)) {
            return false;
        }

        CreateChargebackPlanResponse other = (CreateChargebackPlanResponse) o;
