...
/**
 * Cloud MACS-managed Exadata insight resource (ExaCC) (ExaCS will be supported in the future). <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MacsManagedCloudExadataInsight.Builder.class)
...
public final class MacsManagedCloudExadataInsight extends ExadataInsight {
    ...
    public static class Builder {
        ...
        public MacsManagedCloudExadataInsight build() {
            MacsManagedCloudExadataInsight model =
                    new MacsManagedCloudExadataInsight(
                            this.id,
                            this.compartmentId,
                            this.exadataName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MacsManagedCloudExadataInsight model) {
    ...
    @Deprecated
    public MacsManagedCloudExadataInsight(
            String id,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MacsManagedCloudExadataInsight(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MacsManagedCloudExadataInsight)) {
            return false;
        }

        MacsManagedCloudExadataInsight other = (MacsManagedCloudExadataInsight) o;
