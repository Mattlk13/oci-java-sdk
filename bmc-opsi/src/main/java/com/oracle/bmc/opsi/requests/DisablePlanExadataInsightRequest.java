...
public class DisablePlanExadataInsightRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DisablePlanExadataInsightRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DisablePlanExadataInsightRequest o) {
        ...
        /**
         * Build the instance of DisablePlanExadataInsightRequest as configured by this builder
         *
         ...
         *
         * @return instance of DisablePlanExadataInsightRequest
         */
        public DisablePlanExadataInsightRequest build() {
            DisablePlanExadataInsightRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DisablePlanExadataInsightRequest
         */
        public DisablePlanExadataInsightRequest buildWithoutInvocationCallback() {
            DisablePlanExadataInsightRequest request = new DisablePlanExadataInsightRequest();
            request.exadataInsightId = exadataInsightId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new DisablePlanExadataInsightRequest(exadataInsightId, ifMatch, opcRequestId,
            // opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisablePlanExadataInsightRequest)) {
            return false;
        }

        DisablePlanExadataInsightRequest other = (DisablePlanExadataInsightRequest) o;
