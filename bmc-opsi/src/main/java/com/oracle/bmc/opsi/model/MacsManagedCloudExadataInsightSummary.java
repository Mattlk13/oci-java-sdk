...
public final class MacsManagedCloudExadataInsightSummary extends ExadataInsightSummary {
    ...
    public static class Builder {
        ...
        public MacsManagedCloudExadataInsightSummary build() {
            MacsManagedCloudExadataInsightSummary model =
                    new MacsManagedCloudExadataInsightSummary(
                            this.id,
                            this.compartmentId,
                            this.exadataName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MacsManagedCloudExadataInsightSummary model) {
    ...
    @Deprecated
    public MacsManagedCloudExadataInsightSummary(
            String id,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MacsManagedCloudExadataInsightSummary)) {
            return false;
        }

        MacsManagedCloudExadataInsightSummary other = (MacsManagedCloudExadataInsightSummary) o;
