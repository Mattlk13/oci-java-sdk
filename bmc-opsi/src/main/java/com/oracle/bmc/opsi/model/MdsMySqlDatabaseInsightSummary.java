...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MdsMySqlDatabaseInsightSummary.Builder.class)
...
public final class MdsMySqlDatabaseInsightSummary extends DatabaseInsightSummary {
    ...
    public static class Builder {
        ...
        public MdsMySqlDatabaseInsightSummary build() {
            MdsMySqlDatabaseInsightSummary model =
                    new MdsMySqlDatabaseInsightSummary(
                            this.id,
                            this.databaseId,
                            this.compartmentId,
                            this.databaseName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MdsMySqlDatabaseInsightSummary model) {
    ...
    @Deprecated
    public MdsMySqlDatabaseInsightSummary(
            String id,
            String databaseId,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MdsMySqlDatabaseInsightSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MdsMySqlDatabaseInsightSummary)) {
            return false;
        }

        MdsMySqlDatabaseInsightSummary other = (MdsMySqlDatabaseInsightSummary) o;
