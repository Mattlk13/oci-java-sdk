...
/**
 * The information about the exadata and chargeback plan. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateChargebackPlanExadataDetails.Builder.class)
...
public final class CreateChargebackPlanExadataDetails extends CreateChargebackPlanDetails {
    ...
    public static class Builder {
        ...
        public CreateChargebackPlanExadataDetails build() {
            CreateChargebackPlanExadataDetails model =
                    new CreateChargebackPlanExadataDetails(
                            this.compartmentId,
                            this.freeformTags,
                            this.definedTags,
                            this.planName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateChargebackPlanExadataDetails model) {
    ...
    @Deprecated
    public CreateChargebackPlanExadataDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateChargebackPlanExadataDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateChargebackPlanExadataDetails)) {
            return false;
        }

        CreateChargebackPlanExadataDetails other = (CreateChargebackPlanExadataDetails) o;
