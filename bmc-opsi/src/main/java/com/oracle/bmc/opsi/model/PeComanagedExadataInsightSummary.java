...
/**
 * Summary of a Private endpoint managed Exadata insight resource (ExaCS). <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = PeComanagedExadataInsightSummary.Builder.class)
...
public final class PeComanagedExadataInsightSummary extends ExadataInsightSummary {
    ...
    public static class Builder {
        ...
        public PeComanagedExadataInsightSummary build() {
            PeComanagedExadataInsightSummary model =
                    new PeComanagedExadataInsightSummary(
                            this.id,
                            this.compartmentId,
                            this.exadataName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PeComanagedExadataInsightSummary model) {
    ...
    @Deprecated
    public PeComanagedExadataInsightSummary(
            String id,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PeComanagedExadataInsightSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PeComanagedExadataInsightSummary)) {
            return false;
        }

        PeComanagedExadataInsightSummary other = (PeComanagedExadataInsightSummary) o;
