 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteChargebackPlanRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class DeleteChargebackPlanRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteChargebackPlanRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteChargebackPlanRequest o) {
        ...
        /**
         * Build the instance of DeleteChargebackPlanRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteChargebackPlanRequest
         */
        public DeleteChargebackPlanRequest build() {
            DeleteChargebackPlanRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteChargebackPlanRequest
         */
        public DeleteChargebackPlanRequest buildWithoutInvocationCallback() {
            DeleteChargebackPlanRequest request = new DeleteChargebackPlanRequest();
            request.chargebackplanId = chargebackplanId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteChargebackPlanRequest(chargebackplanId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteChargebackPlanRequest)) {
            return false;
        }

        DeleteChargebackPlanRequest other = (DeleteChargebackPlanRequest) o;
