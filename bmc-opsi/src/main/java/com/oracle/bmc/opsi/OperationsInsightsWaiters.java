...
public class OperationsInsightsWaiters {
     ...
     * @return a new {@code com.oracle.bmc.waiter.Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetChargebackPlanRequest, GetChargebackPlanResponse>
            forChargebackPlan(
    ...
    // Helper method to create a new Waiter for ChargebackPlan.
    private com.oracle.bmc.waiter.Waiter<GetChargebackPlanRequest, GetChargebackPlanResponse>
            forChargebackPlan(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetChargebackPlanRequest request,
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetChargebackPlanResponse apply(
                                    GetChargebackPlanRequest request) {
                                return client.getChargebackPlan(request);
                            }
                        },
                        new java.util.function.Predicate<GetChargebackPlanResponse>() {
                            @Override
                            public boolean test(GetChargebackPlanResponse response) {
                                return targetStatesSet.contains(
                                        response.getChargebackPlan().getLifecycleState());
                            }
                        },
