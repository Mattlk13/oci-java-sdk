...
/**
 * Configuration Summary of autonomous database. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AutonomousDatabaseConfigurationSummary.Builder.class)
...
public final class AutonomousDatabaseConfigurationSummary extends DatabaseConfigurationSummary {
    ...
    @Deprecated
    public AutonomousDatabaseConfigurationSummary(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutonomousDatabaseConfigurationSummary)) {
            return false;
        }
