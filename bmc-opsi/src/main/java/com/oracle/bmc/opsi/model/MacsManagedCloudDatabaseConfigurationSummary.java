...
/**
 * Configuration Summary of a Macs Managed Cloud database. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MacsManagedCloudDatabaseConfigurationSummary.Builder.class)
...
public final class MacsManagedCloudDatabaseConfigurationSummary
    ...
    public static class Builder {
        ...
        public MacsManagedCloudDatabaseConfigurationSummary build() {
            MacsManagedCloudDatabaseConfigurationSummary model =
                    new MacsManagedCloudDatabaseConfigurationSummary(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MacsManagedCloudDatabaseConfigurationSummary model) {
    ...
    @Deprecated
    public MacsManagedCloudDatabaseConfigurationSummary(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MacsManagedCloudDatabaseConfigurationSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MacsManagedCloudDatabaseConfigurationSummary)) {
            return false;
        }

        MacsManagedCloudDatabaseConfigurationSummary other =
                (MacsManagedCloudDatabaseConfigurationSummary) o;
