 ...
 * Bring-Your-Own-License (BYOL), is a permit (entitlement) customer purchased from Broadcom and
 * registered in OCI to install VMware software. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ByolSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ByolSummary extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public ByolSummary(
            ...
            String displayName,
            Byol.LifecycleState lifecycleState,
    ...
    public static class Builder {
        ...
        /**
         * The current state of the BYOL. Accepted values are: - CREATING - ACTIVE - INACTIVE -
         * UPDATING - DELETING - DELETED - FAILED
         */
        @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
        private Byol.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(Byol.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ByolSummary model) {
    ...
    /**
     * The current state of the BYOL. Accepted values are: - CREATING - ACTIVE - INACTIVE - UPDATING
     * - DELETING - DELETED - FAILED
     */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final Byol.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public Byol.LifecycleState getLifecycleState() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ByolSummary)) {
            return false;
        }

        ByolSummary other = (ByolSummary) o;
