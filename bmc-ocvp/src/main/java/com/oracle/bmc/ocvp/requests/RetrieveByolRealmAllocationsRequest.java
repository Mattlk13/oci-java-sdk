...
public class RetrieveByolRealmAllocationsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    RetrieveByolRealmAllocationsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(RetrieveByolRealmAllocationsRequest o) {
            byolId(o.getByolId());
            limit(o.getLimit());
            page(o.getPage());
        ...
        /**
         * Build the instance of RetrieveByolRealmAllocationsRequest as configured by this builder
         *
         ...
         *
         * @return instance of RetrieveByolRealmAllocationsRequest
         */
        public RetrieveByolRealmAllocationsRequest build() {
            RetrieveByolRealmAllocationsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RetrieveByolRealmAllocationsRequest
         */
        public RetrieveByolRealmAllocationsRequest buildWithoutInvocationCallback() {
            RetrieveByolRealmAllocationsRequest request = new RetrieveByolRealmAllocationsRequest();
            ...
            return request;
            // new RetrieveByolRealmAllocationsRequest(byolId, limit, page, sortOrder, sortBy,
            // opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RetrieveByolRealmAllocationsRequest)) {
            return false;
        }

        RetrieveByolRealmAllocationsRequest other = (RetrieveByolRealmAllocationsRequest) o;
