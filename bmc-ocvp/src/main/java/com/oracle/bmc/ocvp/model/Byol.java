...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Byol.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class Byol extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Byol model) {
     ...
     * (VMware Avi Load Balancer)
     */
    public enum SoftwareType implements com.oracle.bmc.http.internal.BmcEnum {
        Vcf("VCF"),
        Vsan("VSAN"),
        Vdefend("VDEFEND"),
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(SoftwareType.class);

        private final String value;
        private static java.util.Map<String, SoftwareType> map;
        ...
        @com.fasterxml.jackson.annotation.JsonCreator
        public static SoftwareType create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'SoftwareType', returning UnknownEnumValue",
                    key);
            return UnknownEnumValue;
        }
    };
