...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ByolAllocation.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ByolAllocation
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ByolAllocation model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ByolAllocation)) {
            return false;
        }

        ByolAllocation other = (ByolAllocation) o;
