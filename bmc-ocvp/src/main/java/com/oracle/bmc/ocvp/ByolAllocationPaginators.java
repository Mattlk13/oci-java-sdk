 ...
 * to any list operations of ByolAllocation where multiple pages of data may be fetched. Two styles
...
public class ByolAllocationPaginators {
     ...
     * listByolAllocations operation. This iterable will fetch more data from the server as needed.
     *
     ...
     * com.oracle.bmc.ocvp.model.ByolAllocationSummary} objects contained in responses from the
     * listByolAllocations operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.ocvp.model.ByolAllocationSummary} objects contained in responses received
     *     from the service.
     */
