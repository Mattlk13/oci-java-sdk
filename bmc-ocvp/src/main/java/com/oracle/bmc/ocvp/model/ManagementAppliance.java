...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ManagementAppliance.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ManagementAppliance
    ...
    public static class Builder {
        ...
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of SDDC
         * in OCI, that this appliance is going to be registered in.
         */
        ...
        public ManagementAppliance build() {
            ManagementAppliance model =
                    new ManagementAppliance(
                            this.id,
                            this.compartmentId,
                            this.sddcId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagementAppliance model) {
    ...
    /**
     * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of SDDC in
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagementAppliance)) {
            return false;
        }

        ManagementAppliance other = (ManagementAppliance) o;
