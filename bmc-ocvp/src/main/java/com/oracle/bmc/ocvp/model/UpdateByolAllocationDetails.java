...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateByolAllocationDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateByolAllocationDetails
    ...
    public UpdateByolAllocationDetails(
            String displayName,
    ...
    public static class Builder {
        ...
        public UpdateByolAllocationDetails build() {
            UpdateByolAllocationDetails model =
                    new UpdateByolAllocationDetails(
                            this.displayName,
                            this.allocatedUnits,
                            this.freeformTags,
                            this.definedTags);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateByolAllocationDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateByolAllocationDetails)) {
            return false;
        }

        UpdateByolAllocationDetails other = (UpdateByolAllocationDetails) o;
