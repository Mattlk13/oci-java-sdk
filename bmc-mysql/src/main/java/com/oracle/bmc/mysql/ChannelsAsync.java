...
public interface ChannelsAsync extends AutoCloseable {
     ...
     * had just been created. This operation is only accepted in Inactive Channels.
     *
     * @param request The request object containing the details to send
     * @param handler The request handler to invoke upon completion, may be null.
     * @return A Future that can be used to get the response if no AsyncHandler was provided. Note,
    ...
    /**
     * Updates the properties of the specified Channel. If the Channel is Active the Update
     * operation will asynchronously apply the new configuration parameters to the Channel and the
     * Channel may become temporarily unavailable. Otherwise, the new configuration will be applied
     * the next time the Channel becomes Active.
     *
     * @param request The request object containing the details to send
     * @param handler The request handler to invoke upon completion, may be null.
     * @return A Future that can be used to get the response if no AsyncHandler was provided. Note,
