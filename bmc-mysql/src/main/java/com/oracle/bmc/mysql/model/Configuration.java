...
/**
 * The set of MySQL variables to be used when deploying a MySQL Database Service DB System. <br>
...
public final class Configuration extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        /**
         * The OCID of the Configuration from which this Configuration is "derived". This is
         * entirely a metadata relationship. There is no relation between the values in this
         * Configuration and its parent.
         */
    ...
    /**
     * The OCID of the Configuration from which this Configuration is "derived". This is entirely a
     * metadata relationship. There is no relation between the values in this Configuration and its
     * parent.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("parentConfigurationId")
