...
/**
 * Runtime status summary of a Channel, aggregating information about health and operational
 * indicators. <br>
...
public final class ChannelStatus extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        /**
         * The date and time that the Work Request to generate the Channel status was issued, as
        ...
        /**
         * The date and time that the Channel status was generated, as described by [RFC
