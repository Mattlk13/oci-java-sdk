...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateComputeGpuMemoryClusterScaleConfig.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateComputeGpuMemoryClusterScaleConfig
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isUpsizeEnabled", "isDownsizeEnabled", "targetSize"})
    public CreateComputeGpuMemoryClusterScaleConfig(
    ...
    public static class Builder {
        ...
        public CreateComputeGpuMemoryClusterScaleConfig build() {
            CreateComputeGpuMemoryClusterScaleConfig model =
                    new CreateComputeGpuMemoryClusterScaleConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateComputeGpuMemoryClusterScaleConfig model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateComputeGpuMemoryClusterScaleConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateComputeGpuMemoryClusterScaleConfig)) {
            return false;
        }

        CreateComputeGpuMemoryClusterScaleConfig other =
                (CreateComputeGpuMemoryClusterScaleConfig) o;
