...
public final class BulkDetachPrivateIpsDetails
    ...
    public static class Builder {
         ...
         * VNIC of which private IPs should be detached. The VNIC and private IPs must be in the
         * same subnet.
         */
     ...
     * of which private IPs should be detached. The VNIC and private IPs must be in the same subnet.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("vnicId")
