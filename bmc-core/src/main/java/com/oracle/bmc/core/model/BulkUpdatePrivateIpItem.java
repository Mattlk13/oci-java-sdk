...
/**
 * secondary private IPv4 address object to update as part of bulk update. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BulkUpdatePrivateIpItem.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BulkUpdatePrivateIpItem
    ...
    public BulkUpdatePrivateIpItem(
            String privateIpId,
    ...
    public static class Builder {
        ...
        public BulkUpdatePrivateIpItem build() {
            BulkUpdatePrivateIpItem model =
                    new BulkUpdatePrivateIpItem(
                            this.privateIpId,
                            this.definedTags,
                            this.displayName,
                            this.freeformTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BulkUpdatePrivateIpItem model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BulkUpdatePrivateIpItem)) {
            return false;
        }

        BulkUpdatePrivateIpItem other = (BulkUpdatePrivateIpItem) o;
