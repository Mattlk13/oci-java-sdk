...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BulkDeleteIpv6sItem.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BulkDeleteIpv6sItem
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"ipv6Id"})
    public BulkDeleteIpv6sItem(String ipv6Id) {
        super();
        this.ipv6Id = ipv6Id;
    }
    ...
    public static class Builder {
        ...
        public BulkDeleteIpv6sItem build() {
            BulkDeleteIpv6sItem model = new BulkDeleteIpv6sItem(this.ipv6Id);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BulkDeleteIpv6sItem model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BulkDeleteIpv6sItem)) {
            return false;
        }

        BulkDeleteIpv6sItem other = (BulkDeleteIpv6sItem) o;
