...
/**
 * Secondary private IPv4 address object to delete as part of bulk deletion. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BulkDeletePrivateIpItem.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BulkDeletePrivateIpItem
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"privateIpId"})
    public BulkDeletePrivateIpItem(String privateIpId) {
        super();
    ...
    public static class Builder {
        ...
        public BulkDeletePrivateIpItem build() {
            BulkDeletePrivateIpItem model = new BulkDeletePrivateIpItem(this.privateIpId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BulkDeletePrivateIpItem model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BulkDeletePrivateIpItem)) {
            return false;
        }

        BulkDeletePrivateIpItem other = (BulkDeletePrivateIpItem) o;
