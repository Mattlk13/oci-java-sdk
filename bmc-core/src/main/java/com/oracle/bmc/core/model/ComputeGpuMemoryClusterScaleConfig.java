...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ComputeGpuMemoryClusterScaleConfig.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ComputeGpuMemoryClusterScaleConfig
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isUpsizeEnabled", "isDownsizeEnabled", "targetSize"})
    public ComputeGpuMemoryClusterScaleConfig(
    ...
    public static class Builder {
        ...
        public ComputeGpuMemoryClusterScaleConfig build() {
            ComputeGpuMemoryClusterScaleConfig model =
                    new ComputeGpuMemoryClusterScaleConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeGpuMemoryClusterScaleConfig model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ComputeGpuMemoryClusterScaleConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeGpuMemoryClusterScaleConfig)) {
            return false;
        }

        ComputeGpuMemoryClusterScaleConfig other = (ComputeGpuMemoryClusterScaleConfig) o;
